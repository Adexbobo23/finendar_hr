"""
Django settings for hrcompany project.
...
SECRET_KEY = 'django-insecure-@mraw1kho^4b8yt@_ky9!=6mf^8+u#(0^)2*r4+(m5inkipphh'
...
WSGI_APPLICATION = 'hrcompany.wsgi.application'
...
JAZZMIN_SETTINGS = {
    'site_header': "FINENDAR",
    'site_brand': "Finendar...",
    # 'site_logo': "assets/images/FINBb.png",
    'copyright':  "All Right Reserved 2023",
    "welcome_sign": "Welcome to FINENDAR, Login Now.",
    "topmenu_links": [
