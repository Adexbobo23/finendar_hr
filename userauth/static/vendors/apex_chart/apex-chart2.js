...
!function(t, e) {
        ...
        return a(i, [{
            ...
            value: function(t) {
                var e = getComputedStyle(t)
                  ...
                  , a = t.clientHeight
                  , s = t.clientWidth;
                return a -= parseFloat(e.paddingTop) + parseFloat(e.paddingBottom),
        ...
        return a(t, [{
            ...
            value: function(t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0
                  ...
                  , h = this.w;
                return t.unfilter(!0),
                u.isIE() && "radialBar" === h.config.chart.type ? t : (r = Array.isArray(r) ? r[i] : r,
                (new window.SVG.Filter).size("120%", "180%", "-5%", "-40%"),
                t.filter(function(t) {
                    var e = null;
                    e = u.isSafari() || u.isFirefox() || u.isIE() ? t.flood(r, o).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(n) : t.flood(r, o).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(n).merge(t.source),
                    t.blend(t.source, e)
                }),
      ...
      , f = function() {
        ...
        return a(t, [{
            ...
            value: function(t, e, i, a, s, n) {
                ...
                i || (i = t.attr("pathFrom")),
                a || (a = t.attr("pathTo")),
                (!i || i.indexOf("undefined") > -1 || i.indexOf("NaN") > -1) && (i = "M 0 ".concat(o.globals.gridHeight),
                s = 1),
                (a.indexOf("undefined") > -1 || a.indexOf("NaN") > -1) && (a = "M 0 ".concat(o.globals.gridHeight),
                s = 1),
                o.globals.shouldAnimate || (s = 1),
                t.plot(i).animate(1, o.globals.easing, n).plot(i).animate(s, o.globals.easing, n).plot(a).afterAll(function() {
                    u.isNumber(e) ? e === o.globals.series[o.globals.maxValsInArrayIndex].length - 2 && o.globals.shouldAnimate && r.animationCompleted(t) : o.globals.shouldAnimate && r.animationCompleted(t),
      ...
      , p = function() {
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                y && (T.node.addEventListener("mouseenter", this.pathMouseEnter.bind(this, T)),
            ...
            key: "drawGradient",
            value: function(t, e, i, a, s) {
                var n, r = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : null, o = arguments.length > 6 && void 0 !== arguments[6] ? arguments[6] : null, l = arguments.length > 7 && void 0 !== arguments[7] ? arguments[7] : null, h = arguments.length > 8 && void 0 !== arguments[8] ? arguments[8] : 0, c = this.w;
                e = u.hexToRgba(e, a),
                i = u.hexToRgba(i, s);
                var d = 0
                  , g = 1
                ...
                x) {
                    ...
                    "vertical" === t ? n.from(0, 0).to(0, 1) : "diagonal" === t ? n.from(0, 0).to(1, 1) : "horizontal" === t ? n.from(0, 1).to(1, 1) : "diagonal2" === t && n.from(0, 1).to(2, 2);
                return n
            }
        }, {
            key: "drawText",
            value: function(t) {
                var e, i = this.w, a = t.x, s = t.y, n = t.text, r = t.textAnchor, o = t.fontSize, l = t.fontFamily, h = t.fontWeight, c = t.foreColor, d = t.opacity;
                return void 0 === n && (n = ""),
                r || (r = "start"),
                c || (c = i.config.chart.foreColor),
                l = l || i.config.chart.fontFamily,
                h = h || "regular",
                (e = Array.isArray(n) ? i.globals.dom.Paper.text(function(t) {
            ...
            value: function(t, e, i) {
                ...
                if ("square" === i.shape) {
                    ...
                    "circle" !== i.shape && i.shape || (u.isNumber(e) || (a = 0,
                    e = 0),
                    s = this.drawCircle(a, {
                        cx: t,
                        cy: e,
            ...
            value: function(t, e) {
                ...
                if ("true" === r) {
                    ...
                    "none" !== i.config.states.active.filter.type && a.getDefaultFilter(t, s);
            ...
            value: function(t, e, i, a) {
                ...
                a && r.attr("transform", a),
                n.globals.dom.Paper.add(r);
                var o = r.bbox();
                return s || (o = r.node.getBoundingClientRect()),
                r.remove(),
                {
                    width: o.width,
                    height: o.height
    ...
    var x = {
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                if (t.globals.axisCharts) {
                    for (var e = this.drawYAxisAnnotations(), i = this.drawXAxisAnnotations(), a = this.drawPointAnnotations(), s = t.config.chart.animations.enabled, n = [e, i, a], r = [i.node, e.node, a.node], o = 0; o < 3; o++)
                        t.globals.dom.elGraphical.add(n[o]),
                        !s || t.globals.resized || t.globals.dataChanged || "scatter" !== t.config.chart.type && "bubble" !== t.config.chart.type && r[o].classList.add("hidden"),
            ...
            value: function(t, e, i) {
                ...
                if (!(r < 0 || r > a.globals.gridWidth)) {
                    if (null === t.x2) {
                        ...
                        if ("category" !== a.config.xaxis.type && !a.config.xaxis.convertedCatToNumeric || this.invertAxis || a.globals.isXNumeric || (c = this.getStringX(t.x2)),
                        c < r) {
                            var d = r;
                            r = c,
                            c = d
            ...
            value: function(t, e, i) {
                var a, s, n = this.w, r = t.strokeDashArray;
                if (this.invertAxis) {
            ...
            value: function(t, e, i) {
                var a = this.w
                  ...
                  , n = 0
                  , r = 0;
                if (this.invertAxis && console.warn("Point annotation is not supported in horizontal bar charts."),
                "string" == typeof t.x) {
                    ...
                    n = a.globals.gridHeight - (h - a.globals.minYArr[t.yAxisIndex]) / (a.globals.yRange[t.yAxisIndex] / a.globals.gridHeight) - parseFloat(t.label.style.fontSize) - t.marker.size,
                    r = a.globals.gridHeight - (h - a.globals.minYArr[t.yAxisIndex]) / (a.globals.yRange[t.yAxisIndex] / a.globals.gridHeight),
                    a.config.yaxis[t.yAxisIndex] && a.config.yaxis[t.yAxisIndex].reversed && (n = (h - a.globals.minYArr[t.yAxisIndex]) / (a.globals.yRange[t.yAxisIndex] / a.globals.gridHeight) + parseFloat(t.label.style.fontSize) + t.marker.size,
                    ...
                    n = a.globals.gridHeight - (parseFloat(t.y) - a.globals.minYArr[t.yAxisIndex]) / (a.globals.yRange[t.yAxisIndex] / a.globals.gridHeight) - parseFloat(t.label.style.fontSize) - t.marker.size,
                    r = a.globals.gridHeight - (t.y - a.globals.minYArr[t.yAxisIndex]) / (a.globals.yRange[t.yAxisIndex] / a.globals.gridHeight),
                    a.config.yaxis[t.yAxisIndex] && a.config.yaxis[t.yAxisIndex].reversed && (n = (parseFloat(t.y) - a.globals.minYArr[t.yAxisIndex]) / (a.globals.yRange[t.yAxisIndex] / a.globals.gridHeight) - parseFloat(t.label.style.fontSize) - t.marker.size,
            ...
            value: function(t, e) {
                ...
                "vertical" === e.label.orientation && (o = e.label.style.padding.left,
            ...
            value: function(t) {
                ...
                return p && l.insertBefore(p.node, f),
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                this.opts.yaxis.forEach(function(e, i) {
                    t.opts.yaxis[i].min = 0,
                    t.opts.yaxis[i].max = 100
                }),
      ...
      , w = function() {
        ...
        return a(t, [{
            ...
            value: function() {
                var t, e, i, a, s = this.w.globals, n = [], r = 0, o = [], l = .1, h = 0;
                if (s.yRange = [],
                s.isMultipleYAxis)
                    ...
                    if (i.config.yaxis[s] && e.w.config.yaxis[s].logarithmic) {
                        ...
                        return a.seriesLog.forEach(function(t, e) {
                            t.forEach(function(t) {
                                i.config.yaxis[e] && i.config.yaxis[e].logarithmic && (r = Math.max(t, r),
                                o = Math.min(t, o))
                            })
                        }),
            ...
            value: function(t) {
                var e = !1
                  , i = !1;
                return t.length && void 0 !== t[0].type && (e = !0,
                t.forEach(function(t) {
            ...
            value: function(t, e) {
                return e.yaxis && (e = t.extendYAxis(e)),
        ...
        return a(i, [{
            ...
            value: function() {
                ...
                if (e && "object" === t(e)) {
                    ...
                    "line" !== e.chart.type && "area" !== e.chart.type && "scatter" !== e.chart.type || o.comboChartsHasBars || "datetime" === e.xaxis.type || "numeric" === e.xaxis.type || "between" === e.xaxis.tickPlacement || (e = y.convertCatToNumeric(e)),
                    (e.chart.sparkline && e.chart.sparkline.enabled || window.Apex.chart && window.Apex.chart.sparkline && window.Apex.chart.sparkline.enabled) && (r = a.sparkline(r)),
                    n = u.extend(s, r)
                }
                var l = u.extend(n, window.Apex);
                return s = u.extend(l, e),
                s = this.handleUserInputErrors(s)
            }
        }, {
            key: "extendYAxis",
            value: function(t) {
                var e = new b;
                return void 0 === t.yaxis && (t.yaxis = {}),
                t.yaxis.constructor !== Array && window.Apex.yaxis && window.Apex.yaxis.constructor !== Array && (t.yaxis = u.extend(t.yaxis, window.Apex.yaxis)),
                t.yaxis.constructor !== Array ? t.yaxis = [u.extend(e.yAxis, t.yaxis)] : t.yaxis = u.extendArray(t.yaxis, e.yAxis),
                t
            }
        }, {
            ...
            value: function(t) {
                var e = new b;
                return t.annotations.yaxis = u.extendArray(void 0 !== t.annotations.yaxis ? t.annotations.yaxis : [], e.yAxisAnnotation),
                t
            }
        }, {
            ...
            value: function(t) {
                var e = new b;
                return t.annotations.xaxis = u.extendArray(void 0 !== t.annotations.xaxis ? t.annotations.xaxis : [], e.xAxisAnnotation),
                t
            }
        }, {
            ...
            value: function(t) {
                var e = new b;
                return t.annotations.points = u.extendArray(void 0 !== t.annotations.points ? t.annotations.points : [], e.pointAnnotation),
                t
            }
        }, {
            ...
            value: function(t) {
                ...
                if (e.chart.scroller && console.warn("Scroller has been deprecated since v2.0.0. Please remove the configuration for chart.scroller"),
                ...
                return "bar" !== e.chart.type && "rangeBar" !== e.chart.type || e.tooltip.shared && ("barWidth" === e.xaxis.crosshairs.width && e.series.length > 1 && (console.warn('crosshairs.width = "barWidth" is only supported in single series, not in a multi-series barChart.'),
                e.xaxis.crosshairs.width = "tickWidth"),
                e.plotOptions.bar.horizontal && (e.states.hover.type = "none",
                e.tooltip.shared = !1),
                e.tooltip.followCursor || (console.warn("followCursor option in shared columns cannot be turned off. Please set %ctooltip.followCursor: true", "color: blue;"),
                e.tooltip.followCursor = !0)),
                "candlestick" === e.chart.type && e.yaxis[0].reversed && (console.warn("Reversed y-axis in candlestick chart is not supported."),
                e.yaxis[0].reversed = !1),
                e.chart.group && 0 === e.yaxis[0].labels.minWidth && console.warn("It looks like you have multiple charts in synchronization. You must provide yaxis.labels.minWidth which must be EQUAL for all grouped charts to prevent incorrect behaviour."),
                Array.isArray(e.stroke.width) && "line" !== e.chart.type && "area" !== e.chart.type && (console.warn("stroke.width option accepts array only for line and area charts. Reverted back to Number"),
      ...
      , A = function() {
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                return e.initialConfig = u.extend({}, t),
        ...
        return a(t, [{
            ...
            value: function(t) {
                var e = this.w
                  ...
                  , o = 0
                  , l = 0;
                void 0 === t.width && void 0 === t.height ? void 0 !== i.fill.image.width && void 0 !== i.fill.image.height ? (o = i.fill.image.width + 1,
                l = i.fill.image.height) : (o = n + 1,
                l = n) : (o = t.width,
                l = t.height);
            ...
            value: function(t) {
                var e = this.w;
                return "bar" === e.config.chart.type && e.config.plotOptions.bar.distributed || "heatmap" === e.config.chart.type ? this.seriesIndex = t.seriesNumber : this.seriesIndex = t.seriesNumber % e.globals.series.length,
                this.seriesIndex
            }
        }, {
            key: "fillPath",
            value: function(t) {
                ...
                -1 === r.indexOf("rgb") ? h = u.hexToRgba(r, l) : r.indexOf("rgba") > -1 && (l = "0." + u.getOpacityFromRGBA(r)),
                "pattern" === o && (a = this.handlePatternFill(a, r, l, h)),
                "gradient" === o && (s = this.handleGradientFill(s, r, l, this.seriesIndex)),
                n.fill.image.src.length > 0 && "image" === o ? t.seriesNumber < n.fill.image.src.length ? (this.clippedImgArea({
                    opacity: l,
                    image: n.fill.image.src[t.seriesNumber],
                    patternUnits: t.patternUnits,
                    patternID: "pattern".concat(e.globals.cuid).concat(t.seriesNumber + 1)
                }),
                i = "url(#pattern".concat(e.globals.cuid).concat(t.seriesNumber + 1, ")")) : i = h : i = "gradient" === o ? s : "pattern" === o ? a : h,
                t.solid && (i = h),
                i
            }
        }, {
            ...
            value: function() {
                var t = this.w
                  ...
                  , i = this.opts
                  , a = [];
                return t.globals.comboCharts ? "line" === t.config.series[this.seriesIndex].type ? t.globals.stroke.colors instanceof Array ? a = t.globals.stroke.colors : a.push(t.globals.stroke.colors) : t.globals.fill.colors instanceof Array ? a = t.globals.fill.colors : a.push(t.globals.fill.colors) : "line" === e.chart.type ? t.globals.stroke.colors instanceof Array ? a = t.globals.stroke.colors : a.push(t.globals.stroke.colors) : t.globals.fill.colors instanceof Array ? a = t.globals.fill.colors : a.push(t.globals.fill.colors),
                void 0 !== i.fillColors && (a = [],
                i.fillColors instanceof Array ? a = i.fillColors.slice() : a.push(i.fillColors)),
                a
            }
        }, {
            ...
            value: function(t, e, i, a) {
                var s, n, r = this.w.config, o = this.opts, l = new p(this.ctx), h = new u, c = r.fill.gradient.type, d = void 0 === r.fill.gradient.opacityFrom ? i : Array.isArray(r.fill.gradient.opacityFrom) ? r.fill.gradient.opacityFrom[a] : r.fill.gradient.opacityFrom, g = void 0 === r.fill.gradient.opacityTo ? i : Array.isArray(r.fill.gradient.opacityTo) ? r.fill.gradient.opacityTo[a] : r.fill.gradient.opacityTo;
                if (s = e,
                n = void 0 === r.fill.gradient.gradientToColors || 0 === r.fill.gradient.gradientToColors.length ? "dark" === r.fill.gradient.shade ? h.shadeColor(-1 * parseFloat(r.fill.gradient.shadeIntensity), e) : h.shadeColor(parseFloat(r.fill.gradient.shadeIntensity), e) : r.fill.gradient.gradientToColors[o.seriesNumber],
      ...
      , L = function() {
        ...
        return a(t, [{
            ...
            value: function(t, e, i) {
                var a, s = this.w, n = e, r = t, o = null, l = new p(this.ctx);
                if (s.globals.markers.size[e] > 0 && (o = l.group({
                    class: "apexcharts-series-markers"
                })).attr("clip-path", "url(#gridRectMarkerMask".concat(s.globals.cuid, ")")),
                r.x instanceof Array)
                    for (var h = 0; h < r.x.length; h++) {
                        ...
                        if ("line" !== s.config.chart.type && "area" !== s.config.chart.type || s.globals.comboCharts || s.config.tooltip.intersect || (d += " no-pointer-events"),
                        Array.isArray(s.config.markers.size) ? s.globals.markers.size[e] > 0 : s.config.markers.size > 0) {
                            ...
                            s.config.series[n].data[i] && (s.config.series[n].data[i].fillColor && (f.pointFillColor = s.config.series[n].data[i].fillColor),
                            s.config.series[n].data[i].strokeColor && (f.pointStrokeColor = s.config.series[n].data[i].strokeColor)),
            ...
            value: function(t, e) {
                ...
                null !== i && r.discrete.length && r.discrete.map(function(t) {
                    t.seriesIndex === e && t.dataPointIndex === i && (s.pointStrokeColor = t.strokeColor,
        ...
        return a(t, [{
                ...
                r.x instanceof Array)
                    for (var c = 0; c < r.x.length; c++) {
                        ...
                        var b = r.x[c]
                          , m = r.y[c];
                        if (g = g || 0,
                        null !== m && void 0 !== a.globals.series[n][d] || (u = !1),
                        u) {
            ...
            value: function(t, e, i, a, s, n, r) {
                var o = this.w
                  ...
                  , v = x.drawCircle(i);
                if (o.config.series[l].data[n] && o.config.series[l].data[n].fillColor && (m = o.config.series[l].data[n].fillColor),
                v.attr({
                    cx: t,
                    cy: e,
                    fill: m,
                ...
                if (o.globals.dataChanged)
                    if (this.dynamicAnim) {
                        ...
                        null != (P = o.globals.previousPaths[s] && o.globals.previousPaths[s][r]) && (k = P.x,
                        A = P.y,
                        S = void 0 !== P.r ? P.r : a);
                        for (var E = 0; E < o.globals.collapsedSeries.length; E++)
                            o.globals.collapsedSeries[E].index === s && (z = 1,
                            a = 0);
                        0 === t && 0 === e && (a = 0),
                        h.animateCircle(v, {
                            cx: k,
        ...
        return a(t, [{
            ...
            value: function(t, e, i) {
                var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "top"
                  ...
                  , h = i
                  , c = null;
                if (!r.enabled || t.x instanceof Array != !0)
                    return c;
                c = n.group({
                    class: "apexcharts-data-labels"
                });
                for (var d = 0; d < t.x.length; d++)
                    if (o = t.x[d] + r.offsetX,
                    ...
                    !isNaN(o)) {
                        ...
                        if ("bubble" === s.config.chart.type)
                            ...
                            void 0 !== u && (g = s.config.dataLabels.formatter(u, {
                                ctx: this.ctx,
                                seriesIndex: e,
                                dataPointIndex: h,
                                w: s
            ...
            value: function(t) {
                ...
                if (!(Array.isArray(e.config.dataLabels.enabledOnSeries) && e.config.dataLabels.enabledOnSeries.indexOf(n) < 0)) {
                    ...
                    if (u && (f = this.dataLabelsCorrection(a, s, o, n, r, d, parseInt(c.style.fontSize))),
                    e.globals.zoomed || (a = f.x,
                    s = f.y),
      ...
      , E = function() {
        ...
        return a(t, [{
            ...
            value: function(t, e) {
                ...
                o++) {
                    var l, h, c, d, g = void 0, f = void 0, x = void 0, b = void 0, m = [], v = [], y = i.globals.comboCharts ? e[r] : r, k = a.group({
                    ...
                    }), z = 0, E = i.globals.dataPoints; z < i.globals.dataPoints; z++,
                    E--) {
                        void 0 === this.series[r][z] || null === t[r][z] ? this.isNullValue = !0 : this.isNullValue = !1,
                        i.config.stroke.show && (A = this.isNullValue ? 0 : Array.isArray(this.strokeWidth) ? this.strokeWidth[y] : this.strokeWidth);
                        var M = null;
            ...
            value: function(t, e, i, a) {
                ...
                return s.config.series[e].data[i] && s.config.series[e].data[i].fillColor && (r = s.config.series[e].data[i].fillColor),
                n.fillPath({
            ...
            value: function(t) {
                ...
                for (var i = 0; i < t.length; i++)
                    if (t[i].length > 0 && (this.seriesLen = this.seriesLen + 1,
                    this.totalItems += t[i].length),
                    e.globals.isXNumeric)
                        for (var a = 0; a < t[i].length; a++)
                            e.globals.seriesX[i][a] > e.globals.minX && e.globals.seriesX[i][a] < e.globals.maxX && this.visibleItems++;
                    else
                        this.visibleItems = e.globals.dataPoints;
            ...
            value: function() {
                ...
                return this.isHorizontal ? (s = (i = l.globals.gridHeight / l.globals.dataPoints) / this.seriesLen,
                ...
                e = (i - s * this.seriesLen) / 2) : (n = (a = l.globals.gridWidth / this.visibleItems) / this.seriesLen * parseInt(this.barOptions.columnWidth) / 100,
                l.globals.isXNumeric && (l.globals.minXDiff && l.globals.minXDiff / this.xRatio > 0 && (a = l.globals.minXDiff / this.xRatio),
            ...
            value: function(t) {
                ...
                if (s = s + u.line(y.newX, m) + y.path + u.line(r, m + i - a) + u.line(r, m),
                ...
                this.barOptions.colors.backgroundBarColors.length > 0 && 0 === g) {
                    ...
                    c.add(k),
                    k.node.classList.add("apexcharts-backgroundBar")
                }
                return {
                    pathTo: s,
                    pathFrom: n,
            ...
            value: function(t) {
                ...
                if (n = n + u.line(v, w.newY) + w.path + u.line(v + o - h, l) + u.line(v - h / 2, l),
                r = r + u.line(v, l) + w.ending_p_from + u.line(v + o - h, l) + u.line(v + o - h, l) + u.line(v - h / 2, l),
                ...
                this.barOptions.colors.backgroundBarColors.length > 0 && 0 === g) {
                    ...
                    c.add(A),
                    A.node.classList.add("apexcharts-backgroundBar")
                }
                return {
                    pathTo: n,
                    pathFrom: r,
            ...
            value: function(t) {
                var e = t.x
                  ...
                  , f = e + parseFloat(l * h)
                  , x = i + parseFloat(o * h);
                d.globals.isXNumeric && !d.globals.isBarHorizontal && (f = e + parseFloat(l * (h + 1)),
                ...
                return d.config.dataLabels.enabled && (S = u.getTextRects(d.globals.yLabelFormatters[0](d.globals.maxY), parseFloat(y.style.fontSize))),
                v = this.isHorizontal ? this.calculateBarsDataLabelsPosition({
                    x: e,
                    y: i,
                    i: a,
                    j: s,
            ...
            value: function(t) {
                var e, i = this.w, a = t.i, s = t.j, n = t.y, r = t.bcx, o = t.barWidth, l = t.barHeight, h = t.textRects, c = t.dataLabelsY, d = t.barDataLabelsConfig, u = t.strokeWidth, g = t.offX, f = t.offY, p = "vertical" === i.config.plotOptions.bar.dataLabels.orientation;
                r -= u / 2;
                var x = i.globals.gridWidth / i.globals.dataPoints;
                if (e = i.globals.isXNumeric ? r - o / 2 + g : r - x + o / 2 + g,
                p) {
                    e = e + h.height / 2 - u / 2 - 2
                }
                var b = this.series[a][s] <= 0;
                switch (this.isReversed && (n -= l),
                d.position) {
                case "center":
            ...
            value: function(t) {
                ...
                if (c.enabled && !m) {
                    ...
                    "vertical" === d.config.plotOptions.bar.dataLabels.orientation && ("top" == w && (c.textAnchor = y ? "end" : "start"),
                    "center" == w && (c.textAnchor = "middle"),
                    "bottom" == w && (c.textAnchor = y ? "end" : "start")),
                    d.config.chart.stacked && this.barOptions.dataLabels.hideOverflowingLabels && (this.isHorizontal ? ((h = this.series[s][n] / this.yRatio[this.yaxisIndex]) > 0 && o.width / 1.6 > h || h < 0 && o.width / 1.6 < h) && (v = "") : (l = this.series[s][n] / this.yRatio[this.yaxisIndex],
                    o.height / 1.6 > l && (v = "")));
                    var k = r({}, c);
                    this.isHorizontal && a < 0 && ("start" === c.textAnchor ? k.textAnchor = "end" : "end" === c.textAnchor && (k.textAnchor = "start")),
            ...
            value: function(t, e, i, a, s) {
                ...
                if (this.isHorizontal) {
                    ...
                    if (void 0 !== i[a][s] || null !== i[a][s]) {
                        ...
                        switch (l && (h = -e.barHeight / 2 - e.strokeWidth),
                ...
                if (void 0 !== i[a][s] || null !== i[a][s]) {
                    ...
                    switch (u && (g = -e.barWidth / 2 - e.strokeWidth),
      ...
      , M = function(t) {
        function i() {
            return e(this, i),
            c(this, l(i).apply(this, arguments))
        }
        return o(i, E),
        a(i, [{
            key: "draw",
            ...
            value: function(t, e, i, a, s, n) {
                var r, o, l = this.w;
                return this.isHorizontal ? (r = (r = a = l.globals.gridHeight / l.globals.dataPoints) * parseInt(l.config.plotOptions.bar.barHeight) / 100,
                ...
                e = (a - r) / 2) : (o = i = l.globals.gridWidth / l.globals.dataPoints,
            ...
            key: "drawBarPaths",
            value: function(t) {
                for (var e, i = t.indexes, a = t.barHeight, s = t.strokeWidth, n = t.pathTo, r = t.pathFrom, o = t.zeroW, l = t.x, h = t.y, c = t.yDivision, d = t.elSeries, u = this.w, g = h, f = i.i, p = i.j, x = i.realIndex, b = i.bc, m = 0, v = 0; v < this.prevXF.length; v++)
                    m += this.prevXF[v][p];
                if (f > 0) {
                    var y = o;
                    this.prevXVal[f - 1][p] < 0 ? y = this.series[f][p] >= 0 ? this.prevX[f - 1][p] + m - 2 * (this.isReversed ? m : 0) : this.prevX[f - 1][p] : this.prevXVal[f - 1][p] >= 0 && (y = this.series[f][p] >= 0 ? this.prevX[f - 1][p] : this.prevX[f - 1][p] - m + 2 * (this.isReversed ? m : 0)),
                    e = y
                } else
                    e = o;
                ...
                if (this.series.length > 1 && f !== this.endingShapeOnSeriesNumber && (k.path = this.graphics.line(k.newX, g + a - s)),
                ...
                n = n + this.graphics.line(k.newX, g) + k.path + this.graphics.line(e, g + a - s) + this.graphics.line(e, g),
                r = r + this.graphics.line(e, g) + this.graphics.line(e, g + a - s) + this.graphics.line(e, g + a - s) + this.graphics.line(e, g + a - s) + this.graphics.line(e, g),
                u.config.plotOptions.bar.colors.backgroundBarColors.length > 0 && 0 === f) {
                    ...
                    d.add(S),
                    S.node.classList.add("apexcharts-backgroundBar")
                }
                return {
                    pathTo: n,
                    pathFrom: r,
            ...
            value: function(t) {
                ...
                if (d.globals.isXNumeric) {
                    ...
                    x || (x = 0),
                    i = (x - d.globals.minX) / this.xRatio - o / 2
                }
                ...
                d.config.plotOptions.bar.colors.backgroundBarColors.length > 0 && 0 === u) {
                    ...
                    c.add(C),
                    C.node.classList.add("apexcharts-backgroundBar")
                }
                return i += s,
                {
                    pathTo: n,
            ...
            value: function(t) {
                for (var e = t.series, i = this.w, a = 0; a < e.length; a++) {
                    for (var s = 0, n = 0; n < e[i.globals.maxValsInArrayIndex].length; n++)
                        s += e[a][n];
      ...
      , T = function(t) {
        ...
        a(i, [{
            ...
            value: function(t, e) {
                ...
                }), o = 0, l = 0; o < t.length; o++,
                l++) {
                    var h, c, d = void 0, g = void 0, f = void 0, x = void 0, b = [], m = [], v = i.globals.comboCharts ? e[o] : o, y = a.group({
                        class: "apexcharts-series",
                    ...
                    E--) {
                        ...
                        i.config.stroke.show && (S = this.isNullValue ? 0 : Array.isArray(this.strokeWidth) ? this.strokeWidth[v] : this.strokeWidth);
            ...
            value: function(t) {
                ...
                return void 0 === this.series[d][u] || null === this.series[d][u] ? k = o : (k = o - k / b,
                A = o - A / b,
                y = o - v.h / b,
                w = o - v.l / b),
                c.move(S, o),
                ...
                s = c.move(S, A) + c.line(S + r / 2, A) + c.line(S + r / 2, y) + c.line(S + r / 2, A) + c.line(S + r, A) + c.line(S + r, k) + c.line(S + r / 2, k) + c.line(S + r / 2, w) + c.line(S + r / 2, k) + c.line(S, k) + c.line(S, A - l / 2),
                n += c.move(S, k),
      ...
      , X = function() {
        ...
        return a(t, [{
            ...
            value: function(t) {
                    ...
                    for (var f = 0, x = 0; x < l[h].length; x++) {
                        ...
                        if (e.globals.dataChanged) {
                            ...
                            if (this.dynamicAnim.enabled && e.globals.shouldAnimate) {
                                ...
                                this.animateHeatColor(A, u.isColorHex(L) ? L : u.rgb2hex(L), u.isColorHex(y) ? y : u.rgb2hex(y), C)
                            }
                        }
                ...
                return e.config.yaxis[0].labels.offsetY = -E / 2,
                a
            }
        }, {
            key: "checkColorRange",
            ...
            value: function(t, e) {
                ...
                s.distributed || (o = i.globals.minY,
                l = i.globals.maxY),
                void 0 !== s.colorScale.min && (o = s.colorScale.min < i.globals.minY ? s.colorScale.min : i.globals.minY,
      ...
      , Y = function() {
        function t(i) {
            ...
            this.defaultSize = a.globals.svgHeight < a.globals.svgWidth ? a.globals.svgHeight - 35 : a.globals.gridWidth,
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                if (e.globals.dataChanged) {
                    ...
                    for (var f = 0; f < e.globals.previousPaths.length; f++)
                        c = this.fullAngle * u.negToZero(e.globals.previousPaths[f]) / d,
            ...
            value: function(t, e) {
                ...
                for (var d = 0; d < t.length; d++) {
                    ...
                    "pie" === i.config.chart.type ? w = u.polarToCartesian(this.centerX, this.centerY, i.globals.radialSize / 1.25 + i.config.plotOptions.pie.dataLabels.offset, o + (h - o) / 2) : "donut" === i.config.chart.type && (w = u.polarToCartesian(this.centerX, this.centerY, (i.globals.radialSize + this.donutSize) / 2 + i.config.plotOptions.pie.dataLabels.offset, o + (h - o) / 2)),
                    f.add(v);
                    var k = 0;
                    if (!this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (k = (h - o) / this.fullAngle * i.config.chart.animations.speed,
                    this.animDur = k + this.animDur,
                    this.animBeginArr.push(this.animDur)),
                    this.dynamicAnim && i.globals.dataChanged ? this.animatePaths(v, {
                        size: i.globals.radialSize,
                        endAngle: h,
                        startAngle: o,
                        prevStartAngle: l,
                    ...
                    i.config.dataLabels.enabled) {
                        ...
                        if (0 !== x && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                            ...
                            i.config.chart.animations.animate && !1 === i.globals.resized && (E.node.classList.add("apexcharts-pie-label-delay"),
            ...
            value: function(t, e) {
                var i = this.w
                  ...
                  , n = e.startAngle
                  , r = e.startAngle;
                void 0 !== e.prevStartAngle && void 0 !== e.prevEndAngle && (n = e.prevEndAngle,
                s = e.prevEndAngle - e.prevStartAngle),
            ...
            key: "animateArc",
            value: function(t, e, i, a, s, n) {
                var r, o = this, l = this.w, h = new f(this.ctx), c = n.size;
                (isNaN(e) || isNaN(s)) && (e = i,
                s = a,
                n.dur = 0);
                var d = a
                ...
                0 !== n.dur ? t.animate(n.dur, l.globals.easing, n.animBeginArr[n.i]).afterAll(function() {
                    ...
                    d = g + (a - g) * l,
                    n.animateStartingPos && (d = s + (a - s) * l,
                    u = e - s + (i - (e - s)) * l),
                    r = o.getPiePath({
                        me: o,
                        startAngle: u,
            ...
            key: "pieClicked",
            value: function(t) {
                var e, i = this.w, a = this.w.globals.radialSize + 4, s = i.globals.dom.Paper.select(".apexcharts-".concat(i.config.chart.type.toLowerCase(), "-slice-").concat(t)).members[0], n = s.attr("d");
            ...
            value: function(t, e) {
                ...
                var c = t.value.formatter
                  , d = ""
                  , u = "";
                if (n ? (r = t.total.color,
                u = t.total.label,
                d = t.total.formatter(i)) : 1 === i.globals.series.length && (d = c(i.globals.series[0], i),
                ...
                t.name.show) {
                    ...
                    g.node.classList.add("apexcharts-datalabel-label"),
                    s.add(g)
                }
                if (t.value.show) {
                    ...
                    x.node.classList.add("apexcharts-datalabel-value"),
                    s.add(x)
                }
                return s
            }
            ...
            value: function(e, i, a) {
                ...
                if (i.total.show && n.globals.series.length > 1) {
                    ...
                    if (Array.prototype.forEach.call(o, function(t) {
                        "true" === t.getAttribute("data:pieClicked") && (l = !0,
                        s.printDataLabelsInner(t, i))
                    }),
                    !l)
      ...
      , F = function() {
        ...
        return a(t, [{
            ...
            key: "drawPolygons",
            value: function(t) {
                for (var e = this, i = this.w, a = t.parent, s = i.globals.yAxisScale[0].result.reverse(), n = s.length, r = [], o = this.size / (n - 1), l = 0; l < n; l++)
                    r[l] = o * l;
                r.reverse();
                var h = []
                  , c = [];
            ...
            value: function() {
                ...
                return e.globals.labels.forEach(function(l, h) {
                    ...
                    if (n[h]) {
                        r = n[h].x,
                        o = n[h].y,
                        Math.abs(n[h].x) >= 10 ? n[h].x > 0 ? (i = "start",
                        r += 10) : n[h].x < 0 && (i = "end",
                        r -= 10) : i = "middle",
      ...
      , R = function(t) {
        ...
        a(i, [{
            ...
            value: function(t) {
                ...
                "back" === e.config.plotOptions.radialBar.hollow.position && (n.add(c),
                x && n.add(x));
                var b = !1;
                ...
                for (var m = b ? t.series.length - 1 : 0; b ? m >= 0 : m < t.series.length; b ? m-- : m++) {
                    ...
                    P = Math.round(A * u.negToZero(e.globals.previousPaths[m]) / 100) + k),
                    Math.abs(L) + Math.abs(w) >= 360 && (L -= .01),
                    Math.abs(P) + Math.abs(k) >= 360 && (P -= .01);
                    var z = L - w
                    ...
                    var I = 0;
                    !this.initialAnim || e.globals.resized || e.globals.dataChanged || (I = (L - w) / 360 * e.config.chart.animations.speed,
                    this.animDur = I / (1.2 * t.series.length) + this.animDur,
                    this.animBeginArr.push(this.animDur)),
                    e.globals.dataChanged && (I = (L - w) / 360 * e.config.chart.animations.dynamicAnimation.speed,
                    this.animDur = I / (1.2 * t.series.length) + this.animDur,
                    this.animBeginArr.push(this.animDur)),
                    this.animatePaths(M, {
                        centerX: t.centerX,
      ...
      , D = function(t) {
        ...
        a(i, [{
            ...
            value: function(t, e) {
                ...
                }), r = 0, o = 0; r < t.length; r++,
                o++) {
                    var l, h, c, d, g = void 0, f = void 0, x = void 0, b = void 0, m = i.globals.comboCharts ? e[r] : r, v = a.group({
                        class: "apexcharts-series",
                    ...
                    for (var S = a.group({
                        class: "apexcharts-datalabels"
                    }), L = 0, P = i.globals.dataPoints; L < i.globals.dataPoints; L++,
                    P--) {
                        this.isNullValue = !1,
                        void 0 !== this.series[r][L] && null !== t[r][L] || (this.isNullValue = !0),
                        i.config.stroke.show && (y = this.isNullValue ? 0 : Array.isArray(this.strokeWidth) ? this.strokeWidth[m] : this.strokeWidth);
                        var z = null;
            ...
            value: function(t) {
                ...
                var v = i + o * this.visibleI;
                void 0 === this.series[d][u] || null === this.series[d][u] ? b = l : (b = l - b / g,
                m = l - m / g);
                var y = Math.abs(m - b);
                return c.move(v, l),
                r = c.move(v, b),
            ...
            value: function(t) {
                ...
                void 0 !== this.series[c][d] && null !== this.series[c][d] && (g = o + this.seriesRangeStart[c][d] / this.invertedYRatio,
                f = o + this.seriesRangeEnd[c][d] / this.invertedYRatio),
                h.move(o, x),
                n = h.move(o, x),
                l.globals.previousPaths.length > 0 && (n = this.getPathFrom(u, d));
                var b = Math.abs(f - g);
                return s = h.move(g, x) + h.line(f, x) + h.line(f, x + r) + h.line(g, x + r) + h.line(g, x),
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                void 0 !== t.config.xaxis.labels.formatter ? t.globals.xLabelFormatter = t.config.xaxis.labels.formatter : t.globals.xLabelFormatter = function(e) {
                    if (u.isNumber(e)) {
                        if ("numeric" === t.config.xaxis.type && t.globals.dataPoints < 50)
                            return e.toFixed(1);
      ...
      , N = function() {
        ...
        return a(t, [{
            key: "getLabel",
            value: function(t, e, i, a) {
                var s, n = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [], r = this.w, o = void 0 === t[a] ? "" : t[a], l = r.globals.xLabelFormatter, h = r.config.xaxis.labels.formatter, c = !1, d = o;
                s = new O(this.ctx).xLabelFormat(l, o, d),
                void 0 !== h && (s = h(o, t[a], a));
                var u, g;
                return e.length > 0 ? (u = e[a].unit,
                g = null,
                ...
                c = g === u,
                i = e[a].position,
                s = e[a].value) : "datetime" === r.config.xaxis.type && void 0 === h && (s = ""),
                void 0 === s && (s = ""),
                (0 === (s = s.toString()).indexOf("NaN") || 0 === s.toLowerCase().indexOf("invalid") || s.toLowerCase().indexOf("infinity") >= 0 || n.indexOf(s) >= 0 && !r.config.xaxis.labels.showDuplicates) && (s = ""),
                {
                    x: i,
                    text: s,
                    isBold: c
      ...
      , H = function() {
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                if (e.config.yaxis[t] && e.config.yaxis[t].reversed && d.reverse(),
                e.config.yaxis[t].labels.show)
                    for (var u = o; u >= 0; u--) {
                        ...
                        0 !== e.config.yaxis[t].labels.rotate && x.node.setAttribute("transform", "rotate(".concat(e.config.yaxis[t].labels.rotate, " ").concat(b.x, " ").concat(b.y, ")")),
                        h += l
                    }
                ...
                if (w.show) {
                    ...
                    n.add(A),
                    this.axesUtils.drawYAxisTicks(k, o, w, e.config.yaxis[t].axisTicks, t, l, n)
                }
                return n
            }
        }, {
            ...
            value: function(t, e) {
                ...
                if (null !== o && (n = o.getBoundingClientRect()),
                null !== o) {
            ...
            value: function(t, e, i, a) {
                ...
                return void 0 === s.config.yaxis[t].title.text || t < 0 ? {
                    xPos: r,
                    padd: 0
                } : (a ? (r = e.width + s.config.yaxis[t].title.offsetX + i.width / 2 + o / 2,
                0 === (n += 1) && (r -= o / 2)) : (r = -1 * e.width + s.config.yaxis[t].title.offsetX + o / 2 + i.width / 2,
                s.globals.isBarHorizontal && (o = 25,
                r = -1 * e.width - s.config.yaxis[t].title.offsetX - o)),
                {
                    xPos: r,
                    padd: o
                })
            ...
            value: function(t, e) {
                ...
                i.config.yaxis.map(function(o, l) {
                    ...
                    o.opposite ? i.globals.isBarHorizontal ? (s = i.globals.gridWidth + i.globals.translateX - 1,
                    i.globals.translateYAxisX[l] = s - o.labels.offsetX) : (s = i.globals.gridWidth + i.globals.translateX + r,
                    h || (r = r + c + 20),
                    i.globals.translateYAxisX[l] = s - o.labels.offsetX + 20) : (a = i.globals.translateX - n,
                    h || (n = n + c + 20),
      ...
      , W = function() {
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                var h = 10;
                switch (e.config.grid.show && "radar" !== e.config.chart.type || (o = 0,
                l = 35),
                this.isSparkline && (t = {
                    height: 0,
                    width: 0
                ...
                case "bottom":
                    i.translateY = h,
                    i.translateX = o,
                    i.gridHeight = i.svgHeight - t.height - l - (this.isSparkline ? 0 : e.globals.rotateXLabels ? 10 : 15),
            ...
            value: function(t) {
                ...
                var s = 10
                  , n = 0;
                if ("pie" === e.config.chart.type || "donut" === e.config.chart.type ? (s += e.config.plotOptions.pie.offsetY,
                n += e.config.plotOptions.pie.offsetX) : "radialBar" === e.config.chart.type && (s += e.config.plotOptions.radialBar.offsetY,
                n += e.config.plotOptions.radialBar.offsetX),
                !e.config.legend.show)
                    return i.gridHeight = i.svgHeight - 35,
            ...
            value: function(t) {
                ...
                if ("category" === i.config.xaxis.type && i.globals.isBarHorizontal || "numeric" === i.config.xaxis.type || "datetime" === i.config.xaxis.type) {
                    ...
                    i.config.yaxis.forEach(function(s, n) {
                        var r;
                        (!s.show || s.floating || -1 !== i.globals.collapsedSeriesIndices.indexOf(n) || a || s.opposite && i.globals.isBarHorizontal) && ((a && i.globals.isMultipleYAxis && -1 !== i.globals.collapsedSeriesIndices.indexOf(n) || i.globals.isBarHorizontal && s.opposite) && (r = t,
                        i.config.grid.padding.left < r.width && (e.xPadLeft = r.width / 2 + 1)),
                        (!i.globals.isBarHorizontal && s.opposite && -1 !== i.globals.collapsedSeriesIndices.indexOf(n) || a && !i.globals.isMultipleYAxis) && function(t) {
            ...
            value: function() {
                ...
                return t.globals.yLabelsCoords.map(function(s, n) {
                    ...
                    s.width > 0 && !r ? (e = e + s.width + i,
                    a(n) && (e = e - s.width - i)) : e += r || !t.config.yaxis[n].show ? 0 : 5
                }),
            ...
            value: function() {
                ...
                e.globals.isBarHorizontal && "datetime" === e.config.xaxis.type && (this.timescaleLabels = e.globals.invertedTimelineLabels.slice());
                ...
                return 1.05 * (t = new p(this.ctx).getTextRects(a, e.config.xaxis.labels.style.fontSize)).width * i.length > e.globals.gridWidth && 0 !== e.config.xaxis.labels.rotate && (e.globals.overlappingXLabels = !0),
                t
            }
        }, {
            ...
            value: function() {
                ...
                if (e.globals.timelineLabels.length > 0) {
                    ...
                    (t = {
                        width: h.width,
                        height: h.height
                    }).width * i.length > e.globals.svgWidth - s - this.yAxisWidth && 0 !== e.config.xaxis.labels.rotate ? e.globals.isBarHorizontal || (e.globals.rotateXLabels = !0,
                    h = l.getTextRects(r, e.config.xaxis.labels.style.fontSize, e.config.xaxis.labels.style.fontFamily, "rotate(".concat(e.config.xaxis.labels.rotate, " 0 0)"), !1),
                    t.height = h.height / 1.66) : e.globals.rotateXLabels = !1
                }
            ...
            value: function() {
                ...
                return e.config.yaxis.map(function(s, n) {
                    if (s.show && s.labels.show && e.globals.yAxisScale[n].result.length) {
                        ...
                        if (void 0 !== o && 0 !== o.length || (o = e.globals.yAxisScale[n].niceMax),
                        e.globals.isBarHorizontal)
                            a = 0,
                            o = r(o = e.globals.labels.slice().reduce(function(t, e) {
                                return t.length > e.length ? t : e
                            }, 0), {
                                seriesIndex: n,
                                dataPointIndex: -1,
        ...
        return a(t, [{
            ...
            value: function(t, e) {
                ...
                if ("mousemove" === t.type) {
                    ...
                    null !== n && (i.globals.axisCharts || n.parentNode.classList.remove("legend-mouseover-inactive"),
            ...
            value: function() {
                ...
                "left" === e.align ? (a = 10,
                n = "start") : "right" === e.align && (a = t.globals.svgWidth - 10,
                n = "end"),
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                if ((i.legend.showForSingleSeries && 1 === e.series.length || e.series.length > 1 || !e.axisCharts) && i.legend.show) {
                    ...
                    this.drawLegends(),
                    u.isIE11() ? document.getElementsByTagName("head")[0].appendChild(this.getLegendStyles()) : this.appendToForeignObject(),
            ...
            value: function() {
                ...
                for (var n = t.globals.legendFormatter, r = t.config.legend.inverseOrder, o = r ? i.length - 1 : 0; r ? o >= 0 : o <= i.length - 1; r ? o-- : o++) {
                    ...
                    A.background = a[o],
                    A.color = a[o],
                    t.config.legend.markers.fillColors && t.config.legend.markers.fillColors[o] && (A.background = t.config.legend.markers.fillColors[o]),
                    ...
                    t.config.legend.markers.customHTML && (Array.isArray(t.config.legend.markers.customHTML) ? g.innerHTML = t.config.legend.markers.customHTML[o]() : g.innerHTML = t.config.legend.markers.customHTML()),
                    p.setAttrs(g, {
                        rel: o + 1,
                        "data:collapsed": h || c
                    }),
                    ...
                    if (!t.config.legend.showForZeroSeries)
                        0 === P.getSeriesTotalByIndex(o) && P.seriesHaveSameValues(o) && !P.isSeriesNull(o) && -1 === t.globals.collapsedSeriesIndices.indexOf(o) && -1 === t.globals.ancillaryCollapsedSeriesIndices.indexOf(o) && S.classList.add("apexcharts-hidden-zero-series");
                    t.config.legend.showForNullSeries || P.isSeriesNull(o) && -1 === t.globals.collapsedSeriesIndices.indexOf(o) && -1 === t.globals.ancillaryCollapsedSeriesIndices.indexOf(o) && S.classList.add("apexcharts-hidden-null-series"),
                    ...
                    S.style.margin = "".concat(t.config.legend.itemMargin.horizontal, "px ").concat(t.config.legend.itemMargin.vertical, "px"),
                ...
                t.config.legend.onItemHover.highlightDataSeries && (t.globals.dom.elWrap.addEventListener("mousemove", this.onLegendHovered, !0),
            ...
            value: function(t, e) {
                ...
                a.style.bottom = 10 + i.config.legend.offsetY + "px") : "right" === i.config.legend.position && (a.style.left = "auto",
            ...
            value: function(t) {
                ...
                if ("heatmap" !== e.config.chart.type)
                    !t.target.classList.contains("inactive-legend") && i && new B(this.ctx).toggleSeriesOnHover(t, t.target);
                else if (i) {
            ...
            value: function(t) {
                if (t.target.classList.contains("apexcharts-legend-text") || t.target.classList.contains("apexcharts-legend-marker")) {
                    ...
                    "function" == typeof s && t.target.classList.contains("apexcharts-legend-marker") && (s(this.ctx, e, this.w),
                    this.ctx.fireEvent("legendMarkerClick", [this.ctx, e, this.w])),
            ...
            value: function(t, e) {
                ...
                if (i.globals.axisCharts || "radialBar" === i.config.chart.type) {
                    ...
                    var a = null
                      , s = null;
                    if (i.globals.risingSeries = [],
                    i.globals.axisCharts ? (a = i.globals.dom.baseEl.querySelector(".apexcharts-series[data\\:realIndex='".concat(t, "']")),
                    s = parseInt(a.getAttribute("data:realIndex"))) : (a = i.globals.dom.baseEl.querySelector(".apexcharts-series[rel='".concat(t + 1, "']")),
                    ...
                    e)
                        ...
                        if (i.globals.axisCharts) {
                            var n = !1;
                            if (i.config.yaxis[s] && i.config.yaxis[s].show && i.config.yaxis[s].showAlways && (n = !0,
                            i.globals.ancillaryCollapsedSeriesIndices.indexOf(s) < 0 && (i.globals.ancillaryCollapsedSeries.push({
                                index: s,
            ...
            value: function(t, e, i) {
                ...
                if (t.length > 0)
                    for (var s = 0; s < t.length; s++)
                        t[s].index === i && (a.globals.axisCharts ? (a.config.series[i].data = t[s].data.slice(),
                        t.splice(s, 1),
                        e.splice(s, 1),
                        a.globals.risingSeries.push(i)) : (a.config.series[i] = t[s].data,
                        t.splice(s, 1),
                        e.splice(s, 1),
      ...
      , G = function() {
        ...
        return a(t, [{
            ...
            value: function(t, e, i) {
                ...
                for (var d = this.xyRatios.zRatio, g = this.xyRatios.xRatio, f = this.xyRatios.baseLineY, x = [], b = [], m = 0, v = 0; v < t.length; v++) {
                    if ("line" === o && ("gradient" === a.config.fill.type || "gradient" === a.config.fill.type[v]) && h.seriesHaveSameValues(v)) {
                        var y = t[v].slice();
                        y[y.length - 1] = y[y.length - 1] + 1e-6,
                        t[v] = y
                    }
                    ...
                    var T = a.globals.padHorizontal + m
                      , I = 1;
                    a.globals.isXNumeric && a.globals.seriesX.length > 0 && (T = (a.globals.seriesX[A][0] - a.globals.minX) / g),
                    P.push(T);
                    var X = void 0
                      , Y = void 0
                      , F = void 0
                    ...
                    null === t[v][0]) {
                        ...
                        X = s.move(_, j),
                        Y = s.move(_, M) + s.line(_, j);
                    if (F = s.move(-1, E) + s.line(-1, E),
                    ...
                    for (var $ = a.globals.dataPoints > 1 ? a.globals.dataPoints - 1 : a.globals.dataPoints, J = 0; J < $; J++) {
                        ...
                        a.config.chart.stacked ? (U = v > 0 && a.globals.collapsedSeries.length < a.config.series.length - 1 ? b[v - 1][J + 1] : E,
                        I = void 0 === t[v][J + 1] || null === t[v][J + 1] ? U - K / c[this.yaxisIndex] + 2 * (this.isReversed ? K / c[this.yaxisIndex] : 0) : U - t[v][J + 1] / c[this.yaxisIndex] + 2 * (this.isReversed ? t[v][J + 1] / c[this.yaxisIndex] : 0)) : I = void 0 === t[v][J + 1] || null === t[v][J + 1] ? E - K / c[this.yaxisIndex] + 2 * (this.isReversed ? K / c[this.yaxisIndex] : 0) : E - t[v][J + 1] / c[this.yaxisIndex] + 2 * (this.isReversed ? t[v][J + 1] / c[this.yaxisIndex] : 0),
                        P.push(T),
                        S.push(I);
                        ...
                        Y = tt.areaPath,
                        X = tt.linePath,
                        this.appendPathFrom && (F += s.line(T, E),
                        R += s.line(T, E));
            ...
            value: function(t) {
                ...
                if (Array.isArray(x.config.stroke.curve) && (m = Array.isArray(f) ? x.config.stroke.curve[f[i]] : x.config.stroke.curve[i]),
                "smooth" === m) {
                    var v = .35 * (s - r);
                    x.globals.hasNullValues ? (null !== e[i][a] && (null !== e[i][a + 1] ? (c = b.move(r, o) + b.curve(r + v, o, s - v, n, s + 1, n),
                    d = b.move(r + 1, o) + b.curve(r + v, o, s - v, n, s + 1, n) + b.line(s, h) + b.line(r, h) + "z") : (c = b.move(r, o),
                    d = b.move(r, o) + "z")),
                    u.push(c),
                    g.push(d)) : (c += b.curve(r + v, o, s - v, n, s, n),
                    d += b.curve(r + v, o, s - v, n, s, n)),
                    r = s,
                    o = n,
                    a === e[i].length - 2 && (d = d + b.curve(r, o, s, n, s, h) + b.move(s, n) + "z",
                    x.globals.hasNullValues || (u.push(c),
                    g.push(d)))
                } else
                    null === e[i][a + 1] && (c += b.move(s, n),
                    d = d + b.line(s - l, h) + b.move(s, n)),
                    null === e[i][a] && (c += b.move(s, n),
                    d += b.move(s, h)),
                    "stepline" === m ? (c = c + b.line(s, null, "H") + b.line(null, n, "V"),
                    d = d + b.line(s, null, "H") + b.line(null, n, "V")) : "straight" === m && (c += b.line(s, n),
                    d += b.line(s, n)),
                    a === e[i].length - 2 && (d = d + b.line(s, h) + b.move(s, n) + "z",
                    u.push(c),
                    g.push(d));
                return {
                    linePaths: u,
            ...
            value: function(t) {
                for (var e = t.pathFromLine, i = t.pathFromArea, a = t.realIndex, s = this.w, n = 0; n < s.globals.previousPaths.length; n++) {
                    ...
                    ("line" === r.type || "area" === r.type) && r.paths.length > 0 && parseInt(r.realIndex) === parseInt(a) && ("line" === r.type ? (this.appendPathFrom = !1,
                    e = s.globals.previousPaths[n].paths[0].d) : "area" === r.type && (this.appendPathFrom = !1,
            ...
            value: function(t) {
                var e = t.i
                  ...
                  , l = this.w;
                if (void 0 !== i[e][0])
                    n = l.config.chart.stacked ? (o = e > 0 ? r[e - 1][0] : s) - i[e][0] / a + 2 * (this.isReversed ? i[e][0] / a : 0) : s - i[e][0] / a + 2 * (this.isReversed ? i[e][0] / a : 0);
      ...
      , _ = function() {
        function t(i) {
            ...
            this.xaxisBorderWidth.indexOf("%") > -1 ? this.xaxisBorderWidth = a.globals.gridWidth * parseInt(this.xaxisBorderWidth) / 100 : this.xaxisBorderWidth = parseInt(this.xaxisBorderWidth),
        ...
        return a(t, [{
            ...
            value: function(t) {
                var e, i, a = this.w, s = new p(this.ctx), n = a.config.yaxis[0].opposite ? a.globals.translateYAxisX[t] : 0, r = s.group({
                ...
                if (a.config.xaxis.axisBorder.show) {
                    ...
                    r.add(v),
                    this.axesUtils.drawYAxisTicks(0, l.length, a.config.yaxis[0].axisBorder, a.config.yaxis[0].axisTicks, 0, e, r)
                }
                return r
            }
        }, {
            ...
            value: function(t, e) {
                ...
                if (!(t < 0 || t > i.globals.gridWidth)) {
                    ...
                    if (i.config.xaxis.axisTicks.show) {
                        ...
                        e.add(r),
                        r.node.classList.add("apexcharts-xaxis-tick")
                    }
                }
            }
        }, {
            ...
            value: function() {
                ...
                if (t.globals.rotateXLabels || t.config.xaxis.labels.rotateAlways)
                    for (var r = 0; r < a.length; r++) {
                        ...
                        o.y = o.y - 1,
                        o.x = o.x + 1,
                        a[r].setAttribute("transform", "rotate(".concat(t.config.xaxis.labels.rotate, " ").concat(o.x, " ").concat(o.y, ")")),
                ...
                if (s.length > 0) {
                    ...
                    g.x + g.width > t.globals.gridWidth && !t.globals.isBarHorizontal && s[0].parentNode.removeChild(s[0]);
                    for (var f = 0; f < n.length; f++)
                        e.placeTextWithEllipsis(n[f], n[f].textContent, t.config.yaxis[0].labels.maxWidth - 2 * parseFloat(t.config.yaxis[0].title.style.fontSize) - 20)
                }
            }
        }]),
        t
      ...
      , j = function() {
        ...
        return a(t, [{
            ...
            value: function(t, e, i) {
                ...
                if (t === Number.MIN_VALUE && 0 === e || !u.isNumber(t) && !u.isNumber(e) || t === Number.MIN_VALUE && e === -Number.MAX_VALUE)
                    return t = 0,
                    e = s,
                    this.linearScale(t, e, s);
                t > e ? (console.warn("yaxis.min cannot be greater than yaxis.max"),
            ...
            value: function(t, e, i, a) {
                ...
                for (var s = Math.log(e) / Math.log(10), n = Math.log(i) / Math.log(10), r = Math.abs(i - e) / a, o = [], l = e; a >= 0; )
                    o.push(l),
                    l += r,
                    a -= 1;
            ...
            value: function(t, e, i) {
                ...
                if (void 0 === a.yAxisScale[t] && (a.yAxisScale[t] = []),
                n.logarithmic)
                    a.allSeriesCollapsed = !1,
                    a.yAxisScale[t] = this.logarithmicScale(t, e, i, n.tickAmount ? n.tickAmount : Math.floor(Math.log10(i)));
                    ...
                    void 0 === n.min && void 0 === n.max || n.forceNiceScale) {
                        ...
                        a.yAxisScale[t] = this.linearScale(e, i, n.tickAmount);
                else
            ...
            value: function() {
                ...
                i.yaxis.forEach(function(r, o) {
                    ...
                    i.series.forEach(function(t, i) {
                        t.name === r.seriesName && -1 === e.collapsedSeriesIndices.indexOf(i) && (l = i,
                        o !== i ? n.push({
                            index: i,
                            similarIndex: o,
                            alreadyExists: !0
            ...
            value: function(t, e, i) {
                ...
                i.forEach(function(t) {
                    t.alreadyExists && (void 0 === r[t.index] && (r[t.index] = []),
                ...
                t.forEach(function(t, e) {
                    d.forEach(function(t, i) {
                        ...
                        t.forEach(function(i, l) {
                            t[l].key === e && (void 0 !== s.yaxis[e].min && (r = "function" == typeof s.yaxis[e].min ? s.yaxis[e].min(n.minY) : s.yaxis[e].min),
            ...
            value: function(t, e, i) {
                ...
                return e.forEach(function(t, r) {
                    ...
                    var h, c, d = a.globals.minYArr[r], u = a.globals.maxYArr[r], g = a.globals.stackedSeriesTotals;
                    a.globals.series.forEach(function(r, l) {
                        ...
                        c = u),
                        (c *= c < 0 ? .9 : 1.1) < 0 && c < u && (c = u),
                        (h *= h < 0 ? 1.1 : .9) < 0 && h > d && (h = d),
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                var o = s.series
                  , l = o
                  , h = o;
                "candlestick" === this.w.config.chart.type ? (l = s.seriesCandleL,
                h = s.seriesCandleH) : s.isRangeData && (l = s.seriesRangeStart,
                h = s.seriesRangeEnd);
                for (var c = t; c < a; c++) {
                    s.dataPoints = Math.max(s.dataPoints, o[c].length);
                    for (var d = 0; d < s.series[c].length; d++) {
                        var g = o[c][d];
                        null !== g && u.isNumber(g) ? (n = Math.max(n, h[c][d]),
                        e = Math.min(e, l[c][d]),
                        i = Math.max(i, l[c][d]),
                        "candlestick" === this.w.config.chart.type && (n = Math.max(n, s.seriesCandleO[c][d]),
                        n = Math.max(n, s.seriesCandleH[c][d]),
                        n = Math.max(n, s.seriesCandleL[c][d]),
                        i = n = Math.max(n, s.seriesCandleC[c][d])),
                        u.isFloat(g) && (g = u.noExponents(g),
                        s.yValueDecimal = Math.max(s.yValueDecimal, g.toString().split(".")[1].length)),
                        r > l[c][d] && l[c][d] < 0 && (r = l[c][d])) : s.hasNullValues = !0
                    }
                }
                return {
                    minY: r,
            ...
            value: function() {
                    ...
                    if (t.series.length)
                        for (var l = 0; l < t.series[t.maxValsInArrayIndex].length; l++)
                            for (var h = 0, c = 0, d = 0; d < t.series.length; d++)
                                null !== t.series[d][l] && u.isNumber(t.series[d][l]) && (t.series[d][l] > 0 ? h = h + parseFloat(t.series[d][l]) + 1e-4 : c += parseFloat(t.series[d][l])),
                                d === t.series.length - 1 && (r.push(h),
                                o.push(c));
                ...
                return e.yaxis.map(function(e, i) {
                    void 0 !== e.max && ("number" == typeof e.max ? t.maxYArr[i] = e.max : "function" == typeof e.max && (t.maxYArr[i] = e.max(t.maxY)),
                    t.maxY = t.maxYArr[i]),
                    void 0 !== e.min && ("number" == typeof e.min ? t.minYArr[i] = e.min : "function" == typeof e.min && (t.minYArr[i] = e.min(t.minY)),
                    t.minY = t.minYArr[i])
                }),
                t.isBarHorizontal && (void 0 !== e.xaxis.min && "number" == typeof e.xaxis.min && (t.minY = e.xaxis.min),
                void 0 !== e.xaxis.max && "number" == typeof e.xaxis.max && (t.maxY = e.xaxis.max)),
                t.isMultipleYAxis ? (this.scales.setMultipleYScales(),
                t.minY = i,
            ...
            key: "setXRange",
            value: function() {
                var t, e = this.w.globals, i = this.w.config, a = "numeric" === i.xaxis.type || "datetime" === i.xaxis.type || "category" === i.xaxis.type && !e.noLabelsProvided || e.noLabelsProvided || e.isXNumeric;
                if (e.isXNumeric)
                    for (var s = 0; s < e.series.length; s++)
                        if (e.labels[s])
                            for (var n = 0; n < e.labels[s].length; n++)
                                null !== e.labels[s][n] && u.isNumber(e.labels[s][n]) && (e.maxX = Math.max(e.maxX, e.labels[s][n]),
                                e.initialmaxX = Math.max(e.maxX, e.labels[s][n]),
                                e.minX = Math.min(e.minX, e.labels[s][n]),
                                e.initialminX = Math.min(e.minX, e.labels[s][n]));
                if (e.noLabelsProvided && 0 === i.xaxis.categories.length && (e.maxX = e.labels[e.labels.length - 1],
                ...
                !e.isXNumeric && !e.noLabelsProvided || i.xaxis.convertedCatToNumeric && !e.dataFormatXNumeric || (void 0 === i.xaxis.tickAmount ? (t = Math.round(e.svgWidth / 150),
                "numeric" === i.xaxis.type && e.dataPoints < 20 && (t = e.dataPoints - 1),
                t > e.dataPoints && 0 !== e.dataPoints && (t = e.dataPoints - 1)) : t = "dataPoints" === i.xaxis.tickAmount ? e.series[e.maxValsInArrayIndex].length - 1 : i.xaxis.tickAmount,
                ...
                e.minX !== Number.MAX_VALUE && e.maxX !== -Number.MAX_VALUE ? e.xAxisScale = this.scales.linearScale(e.minX, e.maxX, t) : (e.xAxisScale = this.scales.linearScale(1, t, t),
                e.noLabelsProvided && e.labels.length > 0 && (e.xAxisScale = this.scales.linearScale(1, e.labels.length, t - 1),
                ...
                if (e.minX === e.maxX)
                    if ("datetime" === i.xaxis.type) {
                        ...
                        e.minX = new Date(h).getTime();
                        var c = new Date(e.maxX);
                        c.setDate(c.getDate() + 2),
                        e.maxX = new Date(c).getTime()
                    } else
                        ("numeric" === i.xaxis.type || "category" === i.xaxis.type && !e.noLabelsProvided) && (e.minX = e.minX - 2,
                        e.maxX = e.maxX + 2);
                    ...
                    for (var e = 0; e < t.series.length; e++)
                        if (void 0 !== t.seriesZ[e])
                            for (var i = 0; i < t.seriesZ[e].length; i++)
                                null !== t.seriesZ[e][i] && u.isNumber(t.seriesZ[e][i]) && (t.maxZ = Math.max(t.maxZ, t.seriesZ[e][i]),
      ...
      , q = function() {
        ...
        return a(t, [{
            ...
            value: function(t, e) {
                ...
                n < .005 ? a.globals.disableZoomIn = !0 : n > 5e4 && (a.globals.disableZoomOut = !0);
            ...
            value: function(t) {
                ...
                for (var x = o + 1, b = l, m = 0, y = 1; m < r; m++,
                y++) {
                    0 === (x = u.monthMod(x)) ? (c = "year",
                    d += 1) : c = "month";
            ...
            value: function(t) {
                var e = t.firstVal
                  ...
                  , c = h
                  , d = function(t, e, i) {
                    return t > r.determineDaysOfMonths(e + 1, i) ? (g = 1,
                    o = "month",
                    c = e += 1,
                    e) : e
                }
            ...
            value: function(t) {
                var e = t.firstVal
                  ...
                  , l = "hour"
                  , h = function(t, e) {
                    return t > o.determineDaysOfMonths(e + 1, s) && (x = 1,
                    e += 1),
                    {
                        month: e,
                        date: x
            ...
            value: function(t, e) {
                var i = t.year;
                return i += "-" + ("0" + t.month.toString()).slice(-2),
            ...
            value: function(t) {
                ...
                return t.map(function(t) {
                    ...
                    if (void 0 === i.config.xaxis.labels.format) {
                        ...
                        a = s.formatDate(r, i.config.xaxis.labels.format);
                    return {
                        dateString: n,
                        position: t.position,
                        value: a,
        ...
        return a(t, [{
            ...
            value: function(t, e) {
                ...
                s.series.map(function(e, a) {
                    void 0 !== t[a].type ? ("column" === t[a].type || "bar" === t[a].type ? (i.config.plotOptions.bar.horizontal = !1,
                    h.series.push(e),
                    h.i.push(a),
                    i.globals.columnSeries = h.series) : "area" === t[a].type ? (r.series.push(e),
                    r.i.push(a)) : "line" === t[a].type ? (n.series.push(e),
                    n.i.push(a)) : "scatter" === t[a].type ? (o.series.push(e),
                    o.i.push(a)) : "bubble" === t[a].type ? (l.series.push(e),
                    l.i.push(a)) : "candlestick" === t[a].type ? (c.series.push(e),
                    c.i.push(a)) : console.warn("You have specified an unrecognized chart type. Available types for this propery are line/area/column/bar/scatter/bubble"),
                    s.comboCharts = !0) : (n.series.push(e),
                    n.i.push(a))
                });
                var d = new G(this.ctx,e)
                  ...
                  , b = [];
                if (s.comboCharts) {
                    if (r.series.length > 0 && b.push(d.draw(r.series, "area", r.i)),
                    h.series.length > 0)
                    ...
                    if (n.series.length > 0 && b.push(d.draw(n.series, "line", n.i)),
                    ...
                    case "bar":
                        if (a.chart.stacked)
                            b = new M(this.ctx,e).draw(s.series);
                        else
                            b = new E(this.ctx,e).draw(s.series);
                        break;
                    case "candlestick":
            ...
            value: function() {
                ...
                if ("%" === a ? u.isNumber(i[0]) && (0 === i[0].width && (i = u.getDimensions(this.el.parentNode)),
                t.svgWidth = i[0] * parseInt(e.chart.width) / 100) : "px" !== a && "" !== a || (t.svgWidth = parseInt(e.chart.width)),
                "auto" !== t.svgHeight && "" !== t.svgHeight)
                    if ("%" === e.chart.height.toString().split(/[0-9]+/g).pop()) {
                        ...
                        t.svgHeight = parseInt(e.chart.height);
                else
                    t.axisCharts ? t.svgHeight = t.svgWidth / 1.61 : t.svgHeight = t.svgWidth;
            ...
            value: function() {
                ...
                e.globals.ignoreYAxisIndexes = e.globals.collapsedSeries.map(function(e, i) {
                    if (t.w.globals.isMultipleYAxis)
                        return e.index
                })
            }
        }, {
            ...
            value: function(t, e) {
                for (var i = this.w.config, a = this.w.globals, s = 0; s < t[e].data.length; s++)
                    if (void 0 !== t[e].data[s][1] && (Array.isArray(t[e].data[s][1]) && 4 === t[e].data[s][1].length ? this.twoDSeries.push(u.parseNumber(t[e].data[s][1][3])) : 5 === t[e].data[s].length ? this.twoDSeries.push(u.parseNumber(t[e].data[s][4])) : this.twoDSeries.push(u.parseNumber(t[e].data[s][1])),
                    ...
                    "datetime" === i.xaxis.type) {
                        ...
                        this.twoDSeriesX.push(t[e].data[s][0]);
                for (var r = 0; r < t[e].data.length; r++)
                    void 0 !== t[e].data[r][2] && (this.threeDSeries.push(t[e].data[r][2]),
                    a.isDataXYZ = !0)
            }
        }, {
            key: "handleFormatXY",
            value: function(t, e) {
                ...
                for (var r = 0; r < t[e].data.length; r++)
                    void 0 !== t[e].data[r].y && (Array.isArray(t[e].data[r].y) ? this.twoDSeries.push(u.parseNumber(t[e].data[r].y[t[e].data[r].y.length - 1])) : this.twoDSeries.push(u.parseNumber(t[e].data[r].y)));
                for (var o = 0; o < t[n].data.length; o++) {
                    var l = "string" == typeof t[n].data[o].x
                      , h = !!s.isValidDate(t[n].data[o].x.toString());
                    l || h ? l ? "datetime" !== i.xaxis.type || a.isRangeData ? (this.fallbackToCategory = !0,
                    this.twoDSeriesX.push(t[n].data[o].x)) : this.twoDSeriesX.push(s.parseDate(t[n].data[o].x)) : "datetime" === i.xaxis.type ? this.twoDSeriesX.push(s.parseDate(t[n].data[o].x.toString())) : (a.dataFormatXNumeric = !0,
                    a.isXNumeric = !0,
                    this.twoDSeriesX.push(parseFloat(t[n].data[o].x))) : (a.isXNumeric = !0,
                    a.dataFormatXNumeric = !0,
            ...
            value: function(t, e) {
                var i = this.w.globals
                  , a = {};
                return this.isFormat2DArray() ? a = this.handleCandleStickDataFormat("array", t, e) : this.isFormatXY() && (a = this.handleCandleStickDataFormat("xy", t, e)),
            ...
            value: function(t, e, i) {
                ...
                if ("array" === t) {
                    if (!Array.isArray(e[i].data[0][1]) && 5 !== e[i].data[0].length || Array.isArray(e[i].data[0][1]) && 4 !== e[i].data[0][1].length)
                        throw new Error(o);
            ...
            value: function(t) {
                for (var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.ctx, i = this.w.config, a = this.w.globals, s = new v(e), n = 0; n < t.length; n++) {
                    ...
                    if ("rangeBar" !== i.chart.type && "rangeArea" !== i.chart.type && "rangeBar" !== t[n].type && "rangeArea" !== t[n].type || (a.isRangeData = !0,
                    ...
                    void 0 !== t[n].name ? a.seriesNames.push(t[n].name) : a.seriesNames.push("series-" + parseInt(n + 1))
                }
                return this.w
            }
        }, {
                ...
                if (e.xaxis.categories.length > 0)
                    ...
                    if (i.axisCharts) {
                        if (i.series.length > 0)
                            for (var s = 0; s < i.series[i.maxValsInArrayIndex].length; s++)
                                a.push(s + 1);
            ...
            value: function() {
                ...
                if (e.globals.axisCharts) {
                    ...
                    if (t = this.coreUtils.getCalculatedRatios(),
                    "datetime" === e.config.xaxis.type && void 0 === e.config.xaxis.labels.formatter) {
                        var i, a = new q(this.ctx);
                        isFinite(e.globals.minX) && isFinite(e.globals.maxX) && !e.globals.isBarHorizontal ? (i = a.calculateTimeScaleTicks(e.globals.minX, e.globals.maxX),
                        a.recalcDimensionsBasedOnFormat(i, !1)) : e.globals.isBarHorizontal && (i = a.calculateTimeScaleTicks(e.globals.minY, e.globals.maxY),
            ...
            key: "drawAxis",
            value: function(t, e) {
                var i, a, s = this.w.globals, n = this.w.config, r = new _(this.ctx), o = new H(this.ctx);
                s.axisCharts && "radar" !== t && (s.isBarHorizontal ? (a = o.drawYaxisInversed(0),
                i = r.drawXaxisInversed(0),
                s.dom.elGraphical.add(i),
                s.dom.elGraphical.add(a)) : (i = r.drawXaxis(),
                s.dom.elGraphical.add(i),
                n.yaxis.map(function(t, e) {
                    -1 === s.ignoreYAxisIndexes.indexOf(e) && (a = o.drawYaxis(e),
                    s.dom.Paper.add(a))
                })));
                n.yaxis.map(function(t, e) {
    ...
    function K(t, e) {
        ...
        Q._immediateFn(function() {
            ...
            if (null !== i) {
                ...
                (1 === t._state ? tt : et)(e.promise, t._value)
        })) : t._deferreds.push(e)
    }
    function tt(t, e) {
        try {
                ...
                try {
                    if (r && ("object" == typeof r || "function" == typeof r)) {
                        ...
                        if ("function" == typeof o)
                            return void o.call(r, function(e) {
                                n(t, e)
                            }, i)
                    }
                    a[t] = r,
    ...
    var nt, rt, ot = function() {
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                a.add(s),
                a.add(n);
                for (var r, o = 8, l = 0; l < t.globals.series.length && (void 0 !== t.globals.yAxisScale[l] && (o = t.globals.yAxisScale[l].result.length - 1),
                !(o > 2)); l++)
                    ;
                if (t.globals.isBarHorizontal) {
                    if (r = o,
                    t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show)
                        for (var h, c = t.globals.padHorizontal, d = t.globals.gridHeight, u = 0; u < r + 1 && (h = c = c + t.globals.gridWidth / r + .3,
                        u !== r - 1); u++) {
                    ...
                    if (r = this.xaxisLabels.length,
                    t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show) {
                        var y, w = t.globals.padHorizontal, k = t.globals.gridHeight;
                        if (t.globals.timelineLabels.length > 0)
                            for (var A = 0; A < r; A++) {
                                if (w = this.xaxisLabels[A].position,
            ...
            value: function(t, e, i) {
                ...
                if (void 0 !== a.config.grid.row.colors && a.config.grid.row.colors.length > 0)
                    for (var n = 0, r = a.globals.gridHeight / i, o = a.globals.gridWidth, l = 0, h = 0; l < i; l++,
                    h++) {
                ...
                if (void 0 !== a.config.grid.column.colors && a.config.grid.column.colors.length > 0)
                    for (var u = a.globals.padHorizontal, g = a.globals.padHorizontal + a.globals.gridWidth / e, f = a.globals.gridHeight, x = 0, b = 0; x < e; x++,
                    b++) {
                      ...
                      , r = function() {
                        ...
                        if (r > a) {
                            ...
                            for (var l = 0; l < s.length; l++)
                                r < s[l].breakpoint && (t = w.extendArrayProps(n, s[l].options),
                                t = u.extend(i.config, t),
                                e.overrideResponsiveOptions(t))
                    };
                    if (t) {
                        var o = w.extendArrayProps(n, t);
                        o = u.extend(i.config, o),
                        r(o = u.extend(o, t))
                    } else
                        r({})
                }
        ...
        return a(t, [{
            ...
            value: function() {
                var t = this.w
                  , e = new u;
                if (t.globals.dom.elWrap.classList.add(t.config.theme.mode),
                void 0 === t.config.colors ? t.globals.colors = this.predefined() : (t.globals.colors = t.config.colors,
                t.globals.axisCharts && "bar" !== t.config.chart.type && Array.isArray(t.config.colors) && t.config.colors.length > 0 && t.config.colors.length === t.config.series.length && (t.globals.colors = t.config.colors.map(function(e, i) {
                ...
                t.config.theme.monochrome.enabled) {
                    ...
                    for (var s = t.config.theme.monochrome.color, n = 1 / (a / t.config.theme.monochrome.shadeIntensity), r = t.config.theme.monochrome.shadeTo, o = 0, l = 0; l < a; l++) {
                        var h = void 0;
                        "dark" === r ? (h = e.shadeColor(-1 * o, s),
                        o += n) : (h = e.shadeColor(o, s),
                        o += n),
                        i.push(h)
                    }
                ...
                void 0 === t.config.plotOptions.radar.polygons.fill.colors ? t.globals.radarPolygons.fill.colors = ["dark" === t.config.theme.mode ? "#202D48" : "#fff"] : t.globals.radarPolygons.fill.colors = t.config.plotOptions.radar.polygons.fill.colors,
            ...
            value: function(t, e) {
                ...
                if (null === i && (i = "bar" === a.config.chart.type && a.config.plotOptions.bar.distributed || "heatmap" === a.config.chart.type && a.config.plotOptions.heatmap.colorScale.inverse),
                i && (s = a.globals.series[0].length * a.globals.series.length),
                t.length < s)
                    for (var n = s - t.length, r = 0; r < n; r++)
                        t.push(t[r])
            }
        }, {
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                var c = a - h.left
                  , d = s - h.top;
                c < 0 || d < 0 || c > r.globals.gridWidth || d > r.globals.gridHeight ? (e.classList.remove("hovering-zoom"),
                ...
                r.globals.isXNumeric && (f = (p = this.closestInMultiArray(c, d, x, g)).index,
                u = p.j,
            ...
            value: function(t) {
                ...
                for (var a = i.allTooltipSeriesGroups, s = 0; s < a.length; s++)
                    "enable" === t ? (a[s].classList.add("active"),
                    a[s].style.display = e.config.tooltip.items.display) : (a[s].classList.remove("active"),
        ...
        return a(t, [{
            ...
            key: "printLabels",
            value: function(t) {
                var e, i = t.i, a = t.j, s = t.values, n = t.ttItems, r = t.shared, o = this.w, l = s.xVal, h = s.zVal, c = s.xAxisTTVal, d = "", u = o.globals.colors[i];
                null !== a && o.config.plotOptions.bar.distributed && (u = o.globals.colors[a]);
                for (var g = 0, f = o.globals.series.length - 1; g < o.globals.series.length; g++,
                f--) {
            ...
            value: function(t) {
                var e = t.i
                  ...
                  , f = null;
                f = a[i].children,
                l.config.tooltip.fillSeriesColor && (a[i].style.backgroundColor = o,
                ...
                (x && (x.innerHTML = c),
                f[0] && f[0].classList.contains("apexcharts-tooltip-marker") && (l.config.tooltip.marker.fillColors && Array.isArray(l.config.tooltip.marker.fillColors) && (o = l.config.tooltip.marker.fillColors[e]),
                f[0].style.backgroundColor = o),
                l.config.tooltip.marker.show || (f[0].style.display = "none"),
                null !== g) && (a[i].querySelector(".apexcharts-tooltip-text-z-label").innerHTML = l.config.tooltip.z.title,
            ...
            value: function(t) {
                ...
                null === i ? o = a.globals.series[e] : a.globals.isXNumeric ? (n = s[e][i],
                0 === s[e].length && (n = s[this.tooltipUtil.getFirstActiveXArray(s)][i])) : n = void 0 !== a.globals.labels[i] ? a.globals.labels[i] : "";
                var c = n;
                ...
                return void 0 !== a.config.tooltip.x.formatter && (n = a.globals.ttKeyFormatter(c, l)),
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                if (null !== e && (n = a.globals.gridWidth / r * e),
                "tickWidth" === a.config.xaxis.crosshairs.width || "barWidth" === a.config.xaxis.crosshairs.width ? n + i.xcrosshairsWidth > a.globals.gridWidth && (n = a.globals.gridWidth - i.xcrosshairsWidth) : null !== e && (n += a.globals.gridWidth / r / 2),
                n < 0 && (n = 0),
                n > a.globals.gridWidth && (n = a.globals.gridWidth),
                null !== s && (s.setAttribute("x", n),
                s.setAttribute("x1", n),
                s.setAttribute("x2", n),
                ...
                i.blxaxisTooltip) {
                    var o = n;
                    "tickWidth" !== a.config.xaxis.crosshairs.width && "barWidth" !== a.config.xaxis.crosshairs.width || (o = n + i.xcrosshairsWidth / 2),
            ...
            value: function(t) {
                ...
                s -= n / 2,
                -1 === e.globals.ignoreYAxisIndexes.indexOf(t) ? (i.yaxisTTEls[t].classList.add("active"),
                i.yaxisTTEls[t].style.top = s + "px",
                i.yaxisTTEls[t].style.left = r + e.config.yaxis[t].tooltip.offsetX + "px") : i.yaxisTTEls[t].classList.remove("active")
            }
        }, {
            key: "moveTooltip",
            value: function(t, e) {
                var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null
                  ...
                  , l = parseFloat(t) + o + 5
                  , h = parseFloat(e) + o / 2;
                if (l > a.globals.gridWidth / 2 && (l = l - r.ttWidth - o - 15),
            ...
            value: function(t, e, i) {
                var a = this.w;
                return t.ttHeight + i > a.globals.gridHeight && (i = a.globals.gridHeight - t.ttHeight + a.globals.translateY),
                i < 0 && (i = 0),
                {
                    x: e,
                    y: i
            ...
            value: function(t, e) {
                ...
                if (i.globals.markers.size[t] > 0)
                    for (var s = i.globals.dom.baseEl.querySelectorAll(" .apexcharts-series[data\\:realIndex='".concat(t, "'] .apexcharts-marker")), n = 0; n < s.length; n++)
                        parseInt(s[n].getAttribute("rel")) === e && (a.marker.resetPointsSize(),
            ...
            value: function(t, e) {
                var i, a, s = this.w, n = this.ttCtx, r = s.globals.pointsArray, o = s.config.markers.hover.size;
                if (void 0 === o && (o = s.globals.markers.size[e] + s.config.markers.hover.sizeOffset),
                !s.config.series[e].type || "column" !== s.config.series[e].type && "candlestick" !== s.config.series[e].type) {
                    i = r[e][t][0],
                    a = r[e][t][1] ? r[e][t][1] : 0;
                    var l = s.globals.dom.baseEl.querySelector(".apexcharts-series[data\\:realIndex='".concat(e, "'] .apexcharts-series-markers circle"));
                    l && (l.setAttribute("r", o),
                    l.setAttribute("cx", i),
                    l.setAttribute("cy", a)),
            ...
            value: function(t) {
                var e, i = this.ttCtx, a = i.w, s = 0, n = 0, r = a.globals.pointsArray;
                ...
                if (null !== (l = null !== h ? h : a.globals.dom.baseEl.querySelectorAll(".apexcharts-series-markers circle")))
                    for (var c = 0; c < l.length; c++) {
                        ...
                        if (d && d.length) {
                            ...
                            null !== u ? (l[g] && l[g].setAttribute("r", o),
                            l[g] && l[g].setAttribute("cy", u)) : l[g] && l[g].setAttribute("r", 0)
                        }
                    }
            ...
            value: function(t) {
                var e, i = this.w, a = this.ttCtx, s = i.globals.columnSeries ? i.globals.columnSeries.length : i.globals.series.length, n = s >= 2 && s % 2 == 0 ? Math.floor(s / 2) : Math.floor(s / 2) + 1, r = i.globals.dom.baseEl.querySelector(".apexcharts-bar-series .apexcharts-series[rel='".concat(n, "'] path[j='").concat(t, "'], .apexcharts-candlestick-series .apexcharts-series[rel='").concat(n, "'] path[j='").concat(t, "'], .apexcharts-rangebar-series .apexcharts-series[rel='").concat(n, "'] path[j='").concat(t, "']")), o = r ? parseFloat(r.getAttribute("cx")) : 0, l = r ? parseFloat(r.getAttribute("barWidth")) : 0;
                i.globals.isXNumeric ? o -= s % 2 != 0 ? l / 2 : 0 : (o = a.xAxisTicksPositions[t - 1] + a.dataPointsDividedWidth / 2,
                isNaN(o) && (o = a.xAxisTicksPositions[t] - a.dataPointsDividedWidth / 2));
                var h = a.getElGrid().getBoundingClientRect();
                if (e = a.e.clientY - h.top - a.tooltipRect.ttHeight / 2,
        ...
        return a(t, [{
            ...
            value: function(t) {
                for (var e = this.w, i = this.ttCtx, a = t, s = e.globals.dom.baseEl.querySelectorAll(".apexcharts-series:not(.apexcharts-series-collapsed) .apexcharts-marker"), n = e.config.markers.hover.size, r = 0; r < s.length; r++) {
                    ...
                    if (void 0 === n && (n = e.globals.markers.size[l] + e.config.markers.hover.sizeOffset),
                    a === parseInt(o)) {
        ...
        return a(t, [{
            ...
            value: function(t) {
                var e, i, a = t.e, s = t.opt, n = this.w, r = this.ttCtx, o = r.getElTooltip(), l = 0, h = 0, c = 0, d = this.getBarTooltipXY({
                    e: a,
                    opt: s
                });
                e = d.i;
                var u = d.barHeight
                  , g = d.j;
                if (n.globals.capturedSeriesIndex = e,
                n.globals.capturedDataPointIndex = g,
                n.globals.isBarHorizontal && r.hasBars() || !n.config.tooltip.shared ? (h = d.x,
                c = d.y,
                i = Array.isArray(n.config.stroke.width) ? n.config.stroke.width[e] : n.config.stroke.width,
                l = h) : n.globals.comboCharts || n.config.tooltip.shared || (l /= 2),
                ...
                if (null === r.tooltip && (r.tooltip = n.globals.dom.baseEl.querySelector(".apexcharts-tooltip")),
                ...
                !r.fixedTooltip && (!n.config.tooltip.shared || n.globals.isBarHorizontal && r.hasBars())) {
                    ...
                    r.tooltipRect.ttHeight + c > n.globals.gridHeight ? (c = n.globals.gridHeight - r.tooltipRect.ttHeight + n.globals.translateY,
                    o.style.top = c + "px") : o.style.top = c + n.globals.translateY - r.tooltipRect.ttHeight / 2 + "px"
                }
            }
        }, {
            key: "getBarTooltipXY",
            value: function(t) {
                ...
                if (d.contains("apexcharts-bar-area") || d.contains("apexcharts-candlestick-area") || d.contains("apexcharts-rangebar-area")) {
                    ...
                    a.config.tooltip.followCursor ? a.globals.isBarHorizontal ? (o = v - f.left + 15,
                    l = m - n.dataPointsDividedHeight + p / 2 - n.tooltipRect.ttHeight / 2) : (o = a.globals.isXNumeric ? b - x / 2 : b - n.dataPointsDividedWidth + x / 2,
                    l = e.clientY - f.top - n.tooltipRect.ttHeight / 2 - 15) : a.globals.isBarHorizontal ? ((o = b) < n.xyRatios.baseLineInvertedY && (o = b - n.tooltipRect.ttWidth),
                    l = m - n.dataPointsDividedHeight + p / 2 - n.tooltipRect.ttHeight / 2) : (o = a.globals.isXNumeric ? b - x / 2 : b - n.dataPointsDividedWidth + x / 2,
                    l = m)
                }
                return {
        ...
        return a(t, [{
            ...
            value: function() {
                ...
                e.blxaxisTooltip && (null === t.globals.dom.baseEl.querySelector(".apexcharts-xaxistooltip") && (e.xaxisTooltip = document.createElement("div"),
            ...
            value: function() {
                for (var t = this.w, e = this.ttCtx, i = function(i) {
                    ...
                    e.blyaxisTooltip && (null === t.globals.dom.baseEl.querySelector(".apexcharts-yaxistooltip apexcharts-yaxistooltip-".concat(i)) && (e.yaxisTooltip = document.createElement("div"),
            ...
            value: function() {
                ...
                if (e.xcrosshairsWidth = parseInt(t.config.xaxis.crosshairs.width),
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                if ((e.globals.comboCharts && !this.tConfig.shared || this.tConfig.intersect && !this.tConfig.shared || ("bar" === e.config.chart.type || "rangeBar" === e.config.chart.type) && !this.tConfig.shared) && (this.showOnIntersect = !0),
            ...
            value: function(t) {
                for (var e = this.w, i = [], a = this.getElTooltip(), s = 0; s < t; s++) {
                    ...
                    this.tConfig.shared && this.tConfig.enabledOnSeries && Array.isArray(this.tConfig.enabledOnSeries) && this.tConfig.enabledOnSeries.indexOf(s) < 0 && n.classList.add("apexcharts-tooltip-series-group-hidden");
            ...
            value: function() {
                ...
                if (t.globals.axisCharts && ("area" === e || "line" === e || "scatter" === e || "bubble" === e ? r = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series[data\\:longestSeries='true'] .apexcharts-marker") : a ? r = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-bar-area, .apexcharts-series .apexcharts-candlestick-area, .apexcharts-series .apexcharts-rangebar-area") : "heatmap" === e ? r = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-heatmap") : "radar" === e && (r = t.globals.dom.baseEl.querySelectorAll(".apexcharts-series .apexcharts-marker")),
                r && r.length))
                    for (var c = 0; c < r.length; c++)
                        o.push(r[c].getAttribute("cy")),
                        l.push(r[c].getAttribute("cx"));
                if (t.globals.xyCharts && !this.showOnIntersect || t.globals.comboCharts && !this.showOnIntersect || a && this.hasBars() && this.tConfig.shared)
                    this.addPathsEventListeners([s], h);
                else if (a && !t.globals.comboCharts)
                    this.addBarsEventListeners(h);
                else if ("bubble" === e || "scatter" === e || "radar" === e || this.showOnIntersect && ("area" === e || "line" === e))
            ...
            value: function() {
                ...
                return this.tConfig.fixed.position.toLowerCase().indexOf("right") > -1 && (n = n + t.globals.svgWidth - a + 10),
            ...
            value: function(t) {
                ...
                i.e = s,
                !i.hasBars() || n.globals.comboCharts || i.isBarShared) || this.tConfig.onDatasetHover.highlightDataSeries && new B(e).toggleSeriesOnHover(s, s.target.parentNode);
                i.fixedTooltip && i.drawFixedTooltipRect(),
                n.globals.axisCharts ? i.axisChartsTooltips({
                    e: s,
                    opt: a,
            ...
            value: function(t) {
                var e, i, a, s = t.e, n = t.opt, r = this.w, o = null, l = n.elGrid.getBoundingClientRect(), h = "touchmove" === s.type ? s.touches[0].clientX : s.clientX, c = "touchmove" === s.type ? s.touches[0].clientY : s.clientY;
                if (this.clientY = c,
                this.clientX = h,
                ...
                c < l.top || c > l.top + l.height)
                    ...
                    if (r.globals.isBarHorizontal && this.hasBars() && (f = !1),
                    "mousemove" === s.type || "touchmove" === s.type || "mouseup" === s.type) {
                        if (null !== g && g.classList.add("active"),
                        ...
                        f && !this.showOnIntersect) {
                            ...
                            this.hasBars && this.intersect.handleBarTooltip({
                                e: s,
                                opt: n
                            }),
                        ...
                        "mouseout" !== s.type && "touchend" !== s.type || this.handleMouseOut(n)
                }
            }
        }, {
            ...
            value: function(t) {
                ...
                if ("mousemove" === e.type || "touchmove" === e.type) {
                    ...
                    "mouseout" !== e.type && "touchend" !== e.type || r.classList.remove("active")
            }
        }, {
            ...
            value: function(t) {
                ...
                if (t.tooltipEl.classList.remove("active"),
            ...
            value: function(t, e, i, a, s) {
                ...
                if (r.config.legend.tooltipHoverFormatter) {
                    ...
                    for (var u = 0; u < d.length; u++) {
                        ...
                        if (n)
                            g.innerHTML = r.globals.collapsedSeriesIndices.indexOf(f) < 0 ? b : x;
                        else if (g.innerHTML = f === i ? b : x,
                        i === f)
                            break
                    }
                }
                if (n) {
                    ...
                    this.hasBars() && (this.barSeriesHeight = this.tooltipUtil.getBarsHeight(h),
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                this.ctx.getSyncedCharts().forEach(function(t) {
                    var i = t.w;
                    i.globals.minX !== i.globals.initialminX && i.globals.maxX !== i.globals.initialmaxX && (t.revertDefaultAxisMinMax(),
                    "function" == typeof i.config.chart.events.zoomed && e.zoomCallback({
        ...
        a(i, [{
            ...
            value: function(t, e) {
                ...
                s.enablePanning()) : this.shiftWasPressed && (s.enableZooming(),
                ...
                !(e.target.classList.contains("apexcharts-selection-rect") || e.target.parentNode.classList.contains("apexcharts-toolbar"))) {
                    ...
                    "mouseup" === e.type || "touchend" === e.type || "mouseleave" === e.type) {
                        ...
                        a.w.globals.mousedown && (a.endX = a.clientX - o.left,
            ...
            value: function(t) {
                ...
                if (this.dragged || null !== o.globals.selection) {
                    ...
                    p.setAttrs(l.node, c)),
                    o.globals.selectionEnabled && (h.attr({
                        x: e,
                        y: i,
                        width: a > 0 ? a : 0,
                        height: s > 0 ? s : 0,
            ...
            value: function(t) {
                var e = t.context
                  ...
                  , d = 0
                  , u = {};
                return Math.abs(l + r) > a.globals.gridWidth ? l = a.globals.gridWidth - r : s.clientX - n.left < 0 && (l = r),
            ...
            value: function(t, e, i) {
                ...
                "left" === t ? (e = a.globals.minX + a.globals.gridWidth / 15 * s.xRatio,
                i = a.globals.maxX + a.globals.gridWidth / 15 * s.xRatio) : "right" === t && (e = a.globals.minX - a.globals.gridWidth / 15 * s.xRatio,
                i = a.globals.maxX - a.globals.gridWidth / 15 * s.xRatio),
                (e < a.globals.initialminX || i > a.globals.initialmaxX) && (e = a.globals.minX,
                i = a.globals.maxX);
                var r = {
                    min: e,
                    max: i
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                n = "start") : "right" === i.align && (a = e.globals.svgWidth - 10,
                n = "end"),
                a += i.offsetX,
    ...
    rt = function(e, i) {
        ...
        a.extend = function() {
            var t, e, i, s;
            for (e = (t = [].slice.call(arguments)).pop(),
            s = t.length - 1; s >= 0; s--)
                if (t[s])
                    for (i in e)
                        t[s].prototype[i] = e[i];
        ...
        a.Color = function(e) {
            ...
            this.g = 0,
            this.b = 0,
            e) && ("string" == typeof e ? a.regex.isRgb.test(e) ? (i = a.regex.rgb.exec(e.replace(a.regex.whitespace, "")),
            this.r = parseInt(i[1]),
            this.g = parseInt(i[2]),
            this.b = parseInt(i[3])) : a.regex.isHex.test(e) && (i = a.regex.hex.exec(4 == (s = e).length ? ["#", s.substring(1, 2), s.substring(1, 2), s.substring(2, 3), s.substring(2, 3), s.substring(3, 4), s.substring(3, 4)].join("") : s),
            this.r = parseInt(i[1], 16),
            this.g = parseInt(i[2], 16),
            this.b = parseInt(i[3], 16)) : "object" === t(e) && (this.r = e.r,
            this.g = e.g,
            this.b = e.b))
        }
        ,
        ...
        a.extend(a.PointArray, {
            ...
            at: function(t) {
                if (!this.destination)
                    return this;
                for (var e = 0, i = this.value.length, s = []; e < i; e++)
                    s.push([this.value[e][0] + (this.destination[e][0] - this.value[e][0]) * t, this.value[e][1] + (this.destination[e][1] - this.value[e][1]) * t]);
            ...
            parse: function(t) {
                ...
                Array.isArray(t)) {
                    ...
                    t = t.trim().split(a.regex.delimiter).map(parseFloat);
                t.length % 2 != 0 && t.pop();
        ...
        a.extend(a.PathArray, {
            ...
            move: function(t, e) {
                ...
                !isNaN(t) && !isNaN(e))
                    for (var a, s = this.value.length - 1; s >= 0; s--)
                        "M" == (a = this.value[s][0]) || "L" == a || "T" == a ? (this.value[s][1] += t,
                        this.value[s][2] += e) : "H" == a ? this.value[s][1] += t : "V" == a ? this.value[s][1] += e : "C" == a || "S" == a || "Q" == a ? (this.value[s][1] += t,
                        this.value[s][2] += e,
                        this.value[s][3] += t,
                        this.value[s][4] += e,
                        "C" == a && (this.value[s][5] += t,
                        this.value[s][6] += e)) : "A" == a && (this.value[s][6] += t,
                        this.value[s][7] += e);
                return this
            },
            size: function(t, e) {
                var i, a, s = this.bbox();
                for (i = this.value.length - 1; i >= 0; i--)
                    "M" == (a = this.value[i][0]) || "L" == a || "T" == a ? (this.value[i][1] = (this.value[i][1] - s.x) * t / s.width + s.x,
                    this.value[i][2] = (this.value[i][2] - s.y) * e / s.height + s.y) : "H" == a ? this.value[i][1] = (this.value[i][1] - s.x) * t / s.width + s.x : "V" == a ? this.value[i][1] = (this.value[i][1] - s.y) * e / s.height + s.y : "C" == a || "S" == a || "Q" == a ? (this.value[i][1] = (this.value[i][1] - s.x) * t / s.width + s.x,
                    ...
                    "C" == a && (this.value[i][5] = (this.value[i][5] - s.x) * t / s.width + s.x,
                    this.value[i][6] = (this.value[i][6] - s.y) * e / s.height + s.y)) : "A" == a && (this.value[i][1] = this.value[i][1] * t / s.width,
            ...
            equalCommands: function(t) {
                var e, i, s;
                for (t = new a.PathArray(t),
                s = this.value.length === t.value.length,
                e = 0,
                i = this.value.length; s && e < i; e++)
                    s = this.value[e][0] === t.value[e][0];
                return s
            },
            morph: function(t) {
                return t = new a.PathArray(t),
            ...
            at: function(t) {
                if (!this.destination)
                    return this;
                var e, i, s, n, r = this.value, o = this.destination.value, l = [], h = new a.PathArray;
                for (e = 0,
                i = r.length; e < i; e++) {
                    for (l[e] = [r[e][0]],
                    s = 1,
        ...
        a.Number = a.invent({
            create: function(t, e) {
                this.value = 0,
                this.unit = e || "",
                "number" == typeof t ? this.value = isNaN(t) ? 0 : isFinite(t) ? t : t < 0 ? -3.4e38 : 3.4e38 : "string" == typeof t ? (e = t.match(a.regex.numberAndUnit)) && (this.value = parseFloat(e[1]),
            ...
            extend: {
                ...
                svg: function(t) {
                    ...
                    if (!(t && this instanceof a.Parent))
                        return e.appendChild(t = i.createElement("svg")),
                        this.writeDataToDom(),
        ...
        a.FX = a.invent({
            ...
            extend: {
                ...
                initAnimations: function() {
                    ...
                    return s.initialTransformation = this.target().matrixify(),
                    s.init = !0,
                    this
                },
                clearQueue: function() {
                ...
                step: function(t) {
                    ...
                    for (var n in this.situation.once)
                        n > this.lastPos && n <= s && (this.situation.once[n].call(this.target(), this.pos, s),
                ...
                eachAt: function() {
                    var t, e, i, s = this, n = this.target(), r = this.situation;
                    ...
                    if (r.transforms.length) {
                        ...
                        t = 0,
                        e = r.transforms.length; t < e; t++) {
                            var o = r.transforms[t];
                            o instanceof a.Matrix ? i = o.relative ? i.multiply((new a.Matrix).morph(o).at(r.ease(this.pos))) : i.morph(o).at(r.ease(this.pos)) : (o.relative || o.undo(i.extract()),
        ...
        a.extend(a.FX, {
            ...
            size: function(t, e) {
                var i;
                this.target()instanceof a.Text ? this.attr("font-size", t) : (t && e || (i = this.target().bbox()),
            ...
            viewbox: function(t, e, i, s) {
                return this.target()instanceof a.Container && this.add("viewbox", new a.ViewBox(t,e,i,s)),
                this
            },
            update: function(t) {
        ...
        a.Matrix = a.invent({
            create: function(e) {
                ...
                for (e = e instanceof a.Element ? e.matrixify() : "string" == typeof e ? p(e.split(a.regex.delimiter).map(parseFloat)) : 6 == arguments.length ? p([].slice.call(arguments)) : Array.isArray(e) ? p(e) : "object" === t(e) ? e : s,
                i = y.length - 1; i >= 0; --i)
            ...
            extend: {
                ...
                scale: function(t, e, i, s) {
                    return 1 == arguments.length ? e = t : 3 == arguments.length && (s = i,
                    i = e,
                    e = t),
                    this.around(i, s, new a.Matrix(t,0,0,e,0,0))
                },
                rotate: function(t, e, i) {
                    return t = a.utils.radians(t),
                ...
                native: function() {
                    for (var t = a.parser.native.createSVGMatrix(), e = y.length - 1; e >= 0; e--)
                        t[y[e]] = this[y[e]];
                    return t
                },
                toString: function() {
        ...
        a.extend(a.Element, {
            attr: function(e, i, s) {
                if (null == e) {
                    for (e = {},
                    s = (i = this.node.attributes).length - 1; s >= 0; s--)
                ...
                if ("object" === t(e))
                    ...
                    if (null == i)
                        return null == (i = this.node.getAttribute(e)) ? a.defaults.attrs[e] : a.regex.isNumber.test(i) ? parseFloat(i) : i;
                    "stroke-width" == e ? this.attr("stroke", parseFloat(i) > 0 ? this._stroke : null) : "stroke" == e && (this._stroke = i),
                    "fill" != e && "stroke" != e || (a.regex.isImage.test(i) && (i = this.doc().defs().image(i, 0, 0)),
                    i instanceof a.Image && (i = this.doc().defs().pattern(0, 0, function() {
                        this.add(i)
                    }))),
                    "number" == typeof i ? i = new a.Number(i) : a.Color.isColor(i) ? i = new a.Color(i) : Array.isArray(i) && (i = new a.Array(i)),
                    "leading" == e ? this.leading && this.leading(i) : "string" == typeof s ? this.node.setAttributeNS(s, e, i.toString()) : this.node.setAttribute(e, i.toString()),
        ...
        a.extend(a.Element, {
            transform: function(e, i) {
                var s, n;
                if ("object" !== t(e))
                    return s = new a.Matrix(this).extract(),
                    "string" == typeof e ? s[e] : s;
                if (s = new a.Matrix(this),
                i = !!i || !!e.relative,
                null != e.a)
                    ...
                    e.flip ? ("x" == e.flip || "y" == e.flip ? e.offset = null == e.offset ? this.bbox()["c" + e.flip] : e.offset : null == e.offset ? (n = this.bbox(),
                    e.flip = n.cx,
                    e.offset = n.cy) : e.flip = e.offset,
                    s = (new a.Matrix).flip(e.flip, e.offset)) : null == e.x && null == e.y || (i ? s = s.translate(e.x, e.y) : (null != e.x && (s.e = e.x),
                    null != e.y && (s.f = e.y)));
        ...
        a.extend(a.FX, {
            transform: function(e, i) {
                ...
                return "object" !== t(e) ? (s = new a.Matrix(r).extract(),
                "string" == typeof e ? s[e] : s) : (i = !!i || !!e.relative,
                null != e.a ? s = new a.Matrix(e) : null != e.rotation ? (x(e, r),
                s = new a.Rotate(e.rotation,e.cx,e.cy)) : null != e.scale || null != e.scaleX || null != e.scaleY ? (x(e, r),
                e.scaleX = null != e.scale ? e.scale : null != e.scaleX ? e.scaleX : 1,
                e.scaleY = null != e.scale ? e.scale : null != e.scaleY ? e.scaleY : 1,
                s = new a.Scale(e.scaleX,e.scaleY,e.cx,e.cy)) : null != e.skewX || null != e.skewY ? (x(e, r),
                e.skewX = null != e.skewX ? e.skewX : 0,
                e.skewY = null != e.skewY ? e.skewY : 0,
                s = new a.Skew(e.skewX,e.skewY,e.cx,e.cy)) : e.flip ? ("x" == e.flip || "y" == e.flip ? e.offset = null == e.offset ? r.bbox()["c" + e.flip] : e.offset : null == e.offset ? (n = r.bbox(),
                e.flip = n.cx,
                e.offset = n.cy) : e.flip = e.offset,
                s = (new a.Matrix).flip(e.flip, e.offset)) : null == e.x && null == e.y || (s = new a.Translate(e.x,e.y)),
                s ? (s.relative = i,
        ...
        a.Transformation = a.invent({
            ...
            extend: {
                ...
                at: function(t) {
                    ...
                    return n = (new a.Matrix).morph(a.Matrix.prototype[this.method].apply(n, e)).at(t),
        ...
        a.extend(a.Element, {
            style: function(e, i) {
                ...
                if (arguments.length < 2)
                    ...
                    this.node.style[c(e)] = null === i || a.regex.isBlank.test(i) ? "" : i;
                return this
            }
        }),
        a.Parent = a.invent({
        ...
        a.extend(a.Parent, {
            ungroup: function(t, e) {
                return 0 === e || this instanceof a.Defs || this.node == a.parser.draw ? this : (t = t || (this instanceof a.Doc ? this : this.parent(a.Parent)),
                e = e || 1 / 0,
                this.each(function() {
        ...
        a.ViewBox = a.invent({
            create: function(e) {
                var i, s, n, r, o, l, h, c = 1, d = 1, u = /[+-]?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?/gi;
                if (e instanceof a.Element) {
                    ...
                    r = new a.Number(e.height()); "%" == n.unit; )
                        c *= n.value,
                    ...
                    e = "string" == typeof e ? e.match(u).map(function(t) {
                        return parseFloat(t)
                    }) : Array.isArray(e) ? e : "object" === t(e) ? [e.x, e.y, e.width, e.height] : 4 == arguments.length ? [].slice.call(arguments) : [0, 0, 0, 0],
                    this.x = e[0],
                    this.y = e[1],
                    this.width = e[2],
                    this.height = e[3]
            ...
            extend: {
                ...
                morph: function(t, e, i, s) {
                    return this.destination = new a.ViewBox(t,e,i,s),
                    this
                },
                at: function(t) {
        ...
        a.off = function(t, e, i) {
            ...
            if (-1 != s)
                if (i) {
                    ...
                    !i)
                        return;
                    a.listeners[s][n] && a.listeners[s][n][r || "*"] && (t.removeEventListener(n, a.listeners[s][n][r || "*"][i], !1),
                    delete a.listeners[s][n][r || "*"][i])
                } else if (r && n) {
                    if (a.listeners[s][n] && a.listeners[s][n][r]) {
                        for (i in a.listeners[s][n][r])
                            a.off(t, [n, r].join("."), i);
        ...
        a.Doc = a.invent({
            create: function(t) {
                t && ("svg" == (t = "string" == typeof t ? i.getElementById(t) : t).nodeName ? this.constructor.call(this, t) : (this.constructor.call(this, a.create("svg")),
            ...
            extend: {
                ...
                defs: function() {
                    var t;
                    this._defs || ((t = this.node.getElementsByTagName("defs")[0]) ? this._defs = a.adopt(t) : this._defs = new a.Defs,
        ...
        a.Mask = a.invent({
            create: function() {
                this.constructor.call(this, a.create("mask")),
                this.targets = []
            },
            inherit: a.Container,
            extend: {
                remove: function() {
                    ...
                    return this.targets = [],
                    a.Element.prototype.remove.call(this),
                    this
                }
            },
            construct: {
        ...
        a.extend(a.Element, {
            maskWith: function(t) {
                return this.masker = t instanceof a.Mask ? t : this.parent().mask().add(t),
        ...
        a.extend(a.Element, {
            clipWith: function(t) {
                return this.clipper = t instanceof a.ClipPath ? t : this.parent().clip().add(t),
        ...
        a.Bare = a.invent({
            create: function(t, e) {
                if (this.constructor.call(this, a.create(t)),
                e)
            ...
            extend: {
                words: function(t) {
                    for (; this.node.hasChildNodes(); )
                        this.node.removeChild(this.node.lastChild);
                    return this.node.appendChild(i.createTextNode(t)),
                    this
                }
            }
        }),
            ...
            extend: {
                load: function(t) {
                    ...
                    return a.on(s, "load", function() {
                        ...
                        null !== e && (0 == i.width() && 0 == i.height() && i.size(s.width, s.height),
        ...
        ["fill", "stroke"].forEach(function(t) {
            ...
            i[t] = function(i) {
                if (void 0 === i)
                    return this;
                if ("string" == typeof i || a.Color.isRgb(i) || i && "function" == typeof i.fill)
                    this.attr(t, i);
                else
        ...
        a.extend(a.Element, {
            data: function(e, i, a) {
                if ("object" === t(e))
                    ...
                    this.attr("data-" + e, null === i ? null : !0 === a || "string" == typeof i || "number" == typeof i ? i : JSON.stringify(i));
                return this
            }
        }),
        a.extend(a.Element, {
    ...
    function() {
        function t(t, s, n, r, o, l, h) {
            for (var c = t.slice(s, n || h), d = r.slice(o, l || h), u = 0, g = {
                ...
                if (c[u] = e.call(g, c[u]),
                d[u] = e.call(f, d[u]),
                c[u][0] != d[u][0] || "M" == c[u][0] || "A" == c[u][0] && (c[u][4] != d[u][4] || c[u][5] != d[u][5]) ? (Array.prototype.splice.apply(c, [u, 1].concat(a.call(g, c[u]))),
                Array.prototype.splice.apply(d, [u, 1].concat(a.call(f, d[u])))) : (c[u] = i.call(g, c[u]),
                d[u] = i.call(f, d[u])),
        ...
        function a(t) {
            ...
            case "A":
                t = (e = function(t, e) {
                    var i, a, s, n, r, o, l, h, c, d, u, g, f, p, x, b, m, v, y, w, k, A, S, C, L, P, z = Math.abs(e[1]), E = Math.abs(e[2]), M = e[3] % 360, T = e[4], I = e[5], X = e[6], Y = e[7], F = new SVG.Point(t), R = new SVG.Point(X,Y), D = [];
                    ...
                    (a = i.x * i.x / (z * z) + i.y * i.y / (E * E)) > 1 && (a = Math.sqrt(a),
                    z *= a,
                    E *= a);
                    s = (new SVG.Matrix).rotate(M).scale(1 / z, 1 / E).rotate(-M),
                    F = F.transform(s),
                    R = R.transform(s),
                    n = [R.x - F.x, R.y - F.y],
                    o = n[0] * n[0] + n[1] * n[1],
                    ...
                    I && u > g && (g += 2 * Math.PI);
                    !I && u < g && (g -= 2 * Math.PI);
                    for (p = Math.ceil(2 * Math.abs(u - g) / Math.PI),
                    b = [],
                    m = u,
                    f = (g - u) / p,
                    x = 4 * Math.tan(f / 4) / 3,
    ...
    function() {
        ...
        t.prototype.drag = function(t) {
            ...
            if ("function" == typeof n) {
                ...
                "object" == typeof n && (null != n.minX && a < n.minX ? r = (a = n.minX) - this.startPoints.box.x : null != n.maxX && a > n.maxX - e.width && (r = (a = n.maxX - e.width) - this.startPoints.box.x),
                ...
                null != n.snapToGrid && (a -= a % n.snapToGrid,
                s -= s % n.snapToGrid,
                r -= r % n.snapToGrid,
                o -= o % n.snapToGrid),
    ...
    function() {
        ...
        t.prototype.selectPoints = function(t) {
            ...
            this.pointSelection.set ? this : (this.pointSelection.set = this.parent.set(),
            this.drawCircles(),
            this)
        }
        ,
        ...
        t.prototype.updateRectSelection = function() {
            ...
            this.options.points && (this.rectSelection.set.get(2).center(t.width, 0),
        ...
        t.prototype.selectRect = function(t) {
            ...
            this.options.points && !this.rectSelection.set.get(1)) {
                var s = "touchstart"
                  , n = "mousedown";
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(0, 0).attr("class", this.options.classPoints + "_lt").on(n, a("lt")).on(s, a("lt"))),
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(i.width, 0).attr("class", this.options.classPoints + "_rt").on(n, a("rt")).on(s, a("rt"))),
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(i.width, i.height).attr("class", this.options.classPoints + "_rb").on(n, a("rb")).on(s, a("rb"))),
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(0, i.height).attr("class", this.options.classPoints + "_lb").on(n, a("lb")).on(s, a("lb"))),
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(i.width / 2, 0).attr("class", this.options.classPoints + "_t").on(n, a("t")).on(s, a("t"))),
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(i.width, i.height / 2).attr("class", this.options.classPoints + "_r").on(n, a("r")).on(s, a("r"))),
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(i.width / 2, i.height).attr("class", this.options.classPoints + "_b").on(n, a("b")).on(s, a("b"))),
                this.rectSelection.set.add(this.nested.circle(this.options.radius).center(0, i.height / 2).attr("class", this.options.classPoints + "_l").on(n, a("l")).on(s, a("l"))),
    ...
    function() {
        (function() {
            ...
            t.prototype.constraintToBox = function(t, e, i, a) {
                ...
                return void 0 !== a ? (s = i,
                n = a) : (s = this.parameters.box.x + (1 & i ? 0 : this.parameters.box.width),
            ...
            t.prototype.checkAspectRatio = function(t, e) {
                ...
                var i = t.slice()
                  ...
                  , r = s / n;
                return r < a ? (i[1] = s / a - this.parameters.box.height,
                e && (i[1] = -i[1])) : r > a && (i[0] = this.parameters.box.width - n * a,
                e && (i[0] = -i[0])),
                i
            }
            ,
        ...
        if ("Element"in t) {
            var e = t.Element.prototype
              ...
              , r = function(t, e) {
                ...
                if (/\s/.test(e))
                    throw new n("INVALID_CHARACTER_ERR","The token must not contain space characters.");
                return s.call(t, e)
            }
              , o = function(t) {
                for (var e = a.call(t.getAttribute("class") || ""), i = e ? e.split(/\s+/) : [], s = 0, n = i.length; s < n; s++)
                    this.push(i[s]);
            ...
            if (n.prototype = Error.prototype,
            l.item = function(t) {
                return this[t] || null
            }
            ,
            ...
            ,
            l.add = function() {
                var t, e = arguments, i = 0, a = e.length, s = !1;
                do {
                    t = e[i] + "",
                    ~r(this, t) || (this.push(t),
                    s = !0)
                } while (++i < a);
            ...
            ,
            l.remove = function() {
                var t, e, i = arguments, a = 0, s = i.length, n = !1;
                do {
                    for (t = i[a] + "",
                    e = r(this, t); ~e; )
                        this.splice(e, 1),
            ...
            i.defineProperty) {
                ...
                i.prototype.__defineGetter__ && e.__defineGetter__("classList", h)
        }
    }(self),
    function() {
    ...
    function() {
        ...
        function e(e) {
            ...
            this.__resizeRAF__ = s(function() {
                ...
                )(i) && (i.__resizeLast__.width = i.offsetWidth,
        ...
        ), n = (a = window.cancelAnimationFrame || window.mozCancelAnimationFrame || window.webkitCancelAnimationFrame || window.clearTimeout,
        function(t) {
            return a(t)
        }
        ), r = !1, o = "animationstart", l = "Webkit Moz O ms".split(" "), h = "webkitAnimationStart animationstart oAnimationStart MSAnimationStart".split(" "), c = document.createElement("fakeelement");
        if (void 0 !== c.style.animationName && (r = !0),
        !1 === r)
        ...
        window.addResizeListener = function(i, a) {
            i.__resizeTriggers__ || ("static" == getComputedStyle(i).position && (i.style.position = "relative"),
            i.__resizeLast__ = {},
            ...
            o && i.__resizeTriggers__.addEventListener(o, function(e) {
        ...
        window.removeResizeListener = function(t, i) {
            t && (t.__resizeListeners__.splice(t.__resizeListeners__.indexOf(i), 1),
            t.__resizeListeners__.length || (t.removeEventListener("scroll", e),
    ...
    function() {
        ...
        return a(i, [{
            ...
            value: function(t, e) {
                ...
                if (i.globals.events.hasOwnProperty(t)) {
                    e && e.length || (e = []);
                    for (var a = i.globals.events[t], s = a.length, n = 0; n < s; n++)
                        a[n].apply(null, e)
                }
            }
        }, {
            ...
            value: function() {
                ...
                return new Q(function(a, s) {
                    ...
                    if ((null === t || i.globals.allSeriesCollapsed) && e.series.handleNoData(),
                    ...
                    if ("front" === i.config.grid.position && e.grid.drawGrid(),
                    ...
                    !i.globals.noData) {
                        if (i.config.tooltip.enabled && !i.globals.noData && e.w.globals.tooltip.drawTooltip(t.xyRatios),
                        i.globals.axisCharts && i.globals.isXNumeric)
                            (i.config.chart.zoom.enabled || i.config.chart.selection && i.config.chart.selection.enabled || i.config.chart.pan && i.config.chart.pan.enabled) && e.zoomPanSelection.init({
                                xyRatios: t.xyRatios
                            });
                        else {
            ...
            value: function(t) {
                var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1]
                  ...
                  , n = this.w;
                return t.series && (this.resetSeries(!1),
                t.series.length && t.series[0].data && (t.series = t.series.map(function(t, e) {
                ...
                t.xaxis.categories && t.xaxis.categories.length && n.config.xaxis.convertedCatToNumeric && (t = y.convertCatToNumeric(t))),
            ...
            value: function(e) {
                ...
                this.w.globals.isExecCalled && (r = [this],
                this.w.globals.isExecCalled = !1),
                r.forEach(function(s) {
                    var r = s.w;
                    return r.globals.shouldAnimate = a,
                    i || (r.globals.resized = !0,
                    r.globals.dataChanged = !0,
                    a && s.series.getPreviousPaths()),
                    e && "object" === t(e) && (s.config = new k(e),
                    e = w.extendArrayProps(s.config, e),
                    r.config = u.extend(r.config, e),
                    n && (r.globals.initialConfig = u.extend({}, r.config),
            ...
            value: function(t, e) {
                ...
                s.config.series = i) : s.config.series = t.slice(),
                a && (s.globals.initialConfig.series = JSON.parse(JSON.stringify(s.config.series)),
            ...
            value: function() {
                ...
                e.config.yaxis.map(function(i, a) {
                    e.globals.zoomed && void 0 !== t.opts.yaxis[a] && (i.min = t.opts.yaxis[a].min,
            ...
            value: function(t) {
                ...
                return this.legend.toggleDataSeries(e.realIndex, e.isHidden),
                e.isHidden
            }
        }, {
            key: "showSeries",
            ...
            value: function() {
                ...
                this.eventList.forEach(function(t) {
                    a.addEventListener(t, function(t) {
                        ...
                        "mousemove" === t.type || "touchmove" === t.type ? "function" == typeof e.config.chart.events.mouseMove && e.config.chart.events.mouseMove(t, i, a) : ("mouseup" === t.type && 1 === t.which || "touchend" === t.type) && ("function" == typeof e.config.chart.events.click && e.config.chart.events.click(t, i, a),
            ...
            value: function(t, e) {
                var i = this.w
                  , a = null;
                i.globals.axisCharts ? a = i.globals.dom.Paper.select(".apexcharts-series[data\\:realIndex='".concat(t, "'] path[j='").concat(e, "'], .apexcharts-series[data\\:realIndex='").concat(t, "'] circle[j='").concat(e, "'], .apexcharts-series[data\\:realIndex='").concat(t, "'] rect[j='").concat(e, "']")).members[0] : (a = i.globals.dom.Paper.select(".apexcharts-series[data\\:realIndex='".concat(t, "']")).members[0],
                ("pie" === i.config.chart.type || "donut" === i.config.chart.type) && new Y(this.ctx).pieClicked(t));
